...
# 死斗增强
execute if score #final jk_bw_mem matches 1 if entity @e[tag=jk_bw_spawn_red,limit=1,scores={jk_bw_TeamDragon=1}] run effect give @a[team=jk_bw_red] strength 1000000 0 true
execute if score #final jk_bw_mem matches 1 if entity @e[tag=jk_bw_spawn_blue,limit=1,scores={jk_bw_TeamDragon=1}] run effect give @a[team=jk_bw_blue] strength 1000000 0 true
execute if score #final jk_bw_mem matches 1 if entity @e[tag=jk_bw_spawn_green,limit=1,scores={jk_bw_TeamDragon=1}] run effect give @a[team=jk_bw_green] strength 1000000 0 true
execute if score #final jk_bw_mem matches 1 if entity @e[tag=jk_bw_spawn_yellow,limit=1,scores={jk_bw_TeamDragon=1}] run effect give @a[team=jk_bw_yellow] strength 1000000 0 true
