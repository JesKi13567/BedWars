...
execute unless score #multi_mode jk_bw_mem matches 1 as @s[tag=!jk_bw_buy_success] run scoreboard players operation #shop_temp jk_bw_mem -= #16 jk_bw_mem
...
execute unless score #multi_mode jk_bw_mem matches 1 as @s[tag=!jk_bw_buy_success] run clear @s[tag=jk_bw_buy_success] diamond 16
execute if score #multi_mode jk_bw_mem matches 1 as @s[tag=!jk_bw_buy_success] run clear @s[tag=jk_bw_buy_success] diamond 8