...
tag @s[scores={jk_bw_PlayerOwnDiamonds=3..}] add jk_bw_buy_success
...
execute as @s[tag=!jk_bw_team_has_sth,tag=!jk_bw_buy_success] run scoreboard players operation #shop_temp jk_bw_mem -= #3 jk_bw_mem
...
clear @s[tag=!jk_bw_team_has_sth,tag=jk_bw_buy_success] diamond 3
