...
execute as @s[tag=!jk_bw_team_has_sth,tag=!jk_bw_buy_success] run scoreboard players operation #shop_temp jk_bw_mem -= #8 jk_bw_mem
...
clear @s[tag=!jk_bw_team_has_sth,tag=jk_bw_buy_success] diamond 8
