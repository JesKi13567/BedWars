...
execute unless score #multi_mode jk_bw_mem matches 1 run tag @s[scores={jk_bw_PlayerOwnExpLevelsReal=240..}] add jk_bw_buy_success
...
execute unless score #multi_mode jk_bw_mem matches 1 unless score #exp_mode jk_bw_mem matches 1 as @s[tag=!jk_bw_team_has_sth,tag=!jk_bw_buy_success] run scoreboard players remove #shop_temp jk_bw_mem 8
execute if score #multi_mode jk_bw_mem matches 1 unless score #exp_mode jk_bw_mem matches 1 as @s[tag=!jk_bw_team_has_sth,tag=!jk_bw_buy_success] run scoreboard players remove #shop_temp jk_bw_mem 4
execute unless score #multi_mode jk_bw_mem matches 1 if score #exp_mode jk_bw_mem matches 1 as @s[tag=!jk_bw_team_has_sth,tag=!jk_bw_buy_success] run scoreboard players remove #shop_temp jk_bw_mem 240
execute if score #multi_mode jk_bw_mem matches 1 if score #exp_mode jk_bw_mem matches 1 as @s[tag=!jk_bw_team_has_sth,tag=!jk_bw_buy_success] run scoreboard players remove #shop_temp jk_bw_mem 120
...
execute unless score #exp_mode jk_bw_mem matches 1 run tellraw @s[tag=!jk_bw_team_has_sth,tag=!jk_bw_buy_success] [{"text":"无法购买","color":"red"},{"text":" 锋利附魔","color":"yellow","bold":true},"，你还需要 ",{"score":{"name": "#shop_temp","objective":"jk_bw_mem"},"color":"yellow"}," 块钻石！"]
execute if score #exp_mode jk_bw_mem matches 1 run tellraw @s[tag=!jk_bw_team_has_sth,tag=!jk_bw_buy_success] [{"text":"无法购买","color":"red"},{"text":" 锋利附魔","color":"yellow","bold":true},"，你还需要 ",{"score":{"name": "#shop_temp","objective":"jk_bw_mem"},"color":"yellow"}," 点经验！"]
...
execute unless score #multi_mode jk_bw_mem matches 1 unless score #exp_mode jk_bw_mem matches 1 run clear @s[tag=!jk_bw_team_has_sth,tag=jk_bw_buy_success] diamond 8
execute if score #multi_mode jk_bw_mem matches 1 unless score #exp_mode jk_bw_mem matches 1 run clear @s[tag=!jk_bw_team_has_sth,tag=jk_bw_buy_success] diamond 4
execute unless score #multi_mode jk_bw_mem matches 1 if score #exp_mode jk_bw_mem matches 1 run scoreboard players remove @s[tag=!jk_bw_team_has_sth,tag=jk_bw_buy_success] jk_bw_PlayerOwnExpLevelsReal 240
execute if score #multi_mode jk_bw_mem matches 1 if score #exp_mode jk_bw_mem matches 1 run scoreboard players remove @s[tag=!jk_bw_team_has_sth,tag=jk_bw_buy_success] jk_bw_PlayerOwnExpLevelsReal 120
