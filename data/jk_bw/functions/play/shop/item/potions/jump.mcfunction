...
# 成功购买
give @s[tag=jk_bw_buy_success] potion{CustomPotionColor:1231137,display:{Name:'{"text":"跳跃提升 V 药水（45 秒）","color":"green","italic":false}'},Potion:"water",CustomPotionEffects:[{Id:8,Amplifier:4,Duration:900,ShowParticles:false}],CanPlaceOn:["#jk_bw:canplaceon"],CanDestroy:["#jk_bw:candestroy"],HideFlags:28}
