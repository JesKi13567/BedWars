...
# 成功购买
give @s[tag=jk_bw_buy_success] potion{display:{Name:'{"text":"速度 II 药水（45 秒）","color":"aqua","italic":false}'},Potion:"water",CustomPotionEffects:[{Id:1,Amplifier:1,Duration:900}],CanPlaceOn:["#jk_bw:canplaceon"],CanDestroy:["#jk_bw:candestroy"],HideFlags:28}
