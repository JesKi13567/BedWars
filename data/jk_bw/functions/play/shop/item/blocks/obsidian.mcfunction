...
tellraw @s[tag=!jk_bw_buy_success] [{"text":"无法购买","color":"red"},{"text":" 黑曜石 ","color":"yellow","bold":true},"*4，你还需要 ",{"score":{"name": "#shop_temp","objective":"jk_bw_mem"},"color":"yellow"}," 块绿宝石！"]
...
clear @s[tag=jk_bw_buy_success] emerald 4