...
# 成功购买
give @s[tag=jk_bw_buy_success] potion{display:{Name:'{"text":"魔法药水（30 秒）","color":"gray","italic":false}'},Potion:"water",CustomPotionEffects:[{Id:26,Amplifier:0,Duration:600}],CanPlaceOn:["#jk_bw:canplaceon"],CanDestroy:["#jk_bw:candestroy"],HideFlags:28}
