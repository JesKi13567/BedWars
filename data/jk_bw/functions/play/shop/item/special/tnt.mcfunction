...
execute unless score #multi_mode jk_bw_mem matches 1 run clear @s[tag=jk_bw_buy_success] gold_ingot 8
execute if score #multi_mode jk_bw_mem matches 1 run clear @s[tag=jk_bw_buy_success] gold_ingot 4