...
tag @s[tag=!jk_bw_player_has_armor,scores={jk_bw_PlayerOwnOwnExpLevelsReal=60..}] add jk_bw_buy_success
...
execute if score #exp_mode jk_bw_mem matches 1 run scoreboard players remove #shop_temp jk_bw_mem 60
