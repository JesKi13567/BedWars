...
# 测试模式防止落入虚空
execute if score #test_mode jk_bw_mem matches 1 run effect give @s[scores={jk_bw_Temp=..-40}] resistance 2 4
execute if score #test_mode jk_bw_mem matches 1 run tp @s[scores={jk_bw_Temp=..-40}] @e[limit=1,tag=jk_bw_spawn_red]
