...
execute positioned ^ ^ ^ if block ^ ^ ^ #jk_bw:canplaceon unless block ^ ^ ^ #jk_bw:canexplode_fireball run tp @s ~ ~0.6 ~
execute positioned ^ ^ ^0.4 if block ^ ^ ^ #jk_bw:canplaceon unless block ^ ^ ^ #jk_bw:canexplode_fireball run scoreboard players set @s jk_bw_mem 1
execute if score @s jk_bw_mem matches 0 positioned ^ ^ ^0.4 if block ^ ^ ^ #jk_bw:canexplode_fireball run summon marker ^ ^ ^ {Tags:["jk_bw","jk_bw_explode","jk_bw_explode_can"]}
execute positioned ^ ^ ^0.8 if block ^ ^ ^ #jk_bw:canplaceon unless block ^ ^ ^ #jk_bw:canexplode_fireball run scoreboard players set @s jk_bw_mem 1
execute if score @s jk_bw_mem matches 0 positioned ^ ^ ^0.8 if block ^ ^ ^ #jk_bw:canexplode_fireball run summon marker ^ ^ ^ {Tags:["jk_bw","jk_bw_explode","jk_bw_explode_can"]}
