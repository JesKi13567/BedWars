...
execute positioned ^ ^ ^ if block ^ ^ ^ #jk_bw:canplaceon unless block ^ ^ ^ #jk_bw:canexplode_tnt run tp @s ~ ~.6 ~
...
execute positioned ^ ^ ^.8 if block ^ ^ ^ #jk_bw:canplaceon unless block ^ ^ ^ #jk_bw:canexplode_tnt run scoreboard players set @s jk_bw_mem 1
execute if score @s jk_bw_mem matches 0 positioned ^ ^ ^.8 if block ^ ^ ^ #jk_bw:canexplode_tnt run summon marker ^ ^ ^ {Tags:["jk_bw","jk_bw_explode","jk_bw_explode_can"]}
