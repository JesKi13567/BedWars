...
data merge block 0 1 0 {Text2:'[{"text":"将在 ","color":"green","bold":true},{"score":{"name":"#summon_emerald","objective":"jk_bw_mem"},"color":"gold"}," 秒后生成"]'}
execute as @e[tag=jk_bw_emerald_time] at @s run data modify entity @s CustomName set from block 0 1 0 Text2
