...
execute as @p[gamemode=creative,distance=..6,y_rotation=135.1..180] run tp @e[tag=jk_bw_bed_blue,limit=1,sort=nearest] ~ ~ ~ 180 0
execute as @p[gamemode=creative,distance=..6,y_rotation=-180..-135] run tp @e[tag=jk_bw_bed_blue,limit=1,sort=nearest] ~ ~ ~ 180 0
execute as @p[gamemode=creative,distance=..6,y_rotation=-134.9..-45] run tp @e[tag=jk_bw_bed_blue,limit=1,sort=nearest] ~ ~ ~ -90 0
execute as @p[gamemode=creative,distance=..6,y_rotation=-44.9..45] run tp @e[tag=jk_bw_bed_blue,limit=1,sort=nearest] ~ ~ ~ 0 0
execute as @p[gamemode=creative,distance=..6,y_rotation=45.1..135] run tp @e[tag=jk_bw_bed_blue,limit=1,sort=nearest] ~ ~ ~ 90 0
