...
# 菜单
execute if score #teams jk_bw_mem matches 2 run tellraw @a[tag=jk_bw_admin] ["\n设置床位点：",{"text":"[红队]","color":"red","clickEvent":{"action":"run_command","value":"/function jk_bw:load/settings/menu/teams/bed/red"}},"  ",{"text":"[蓝队]","color":"blue","clickEvent":{"action":"run_command","value":"/function jk_bw:load/settings/menu/teams/bed/blue"}},{"text":"  [提示]","color":"gray","hoverEvent":{"action":"show_text","value":"若在游戏结束后发现床不在标记点请无视。"}}]
execute if score #teams jk_bw_mem matches 4 run tellraw @a[tag=jk_bw_admin] ["\n设置床位点：",{"text":"[红队]","color":"red","clickEvent":{"action":"run_command","value":"/function jk_bw:load/settings/menu/teams/bed/red"}},"  ",{"text":"[蓝队]","color":"blue","clickEvent":{"action":"run_command","value":"/function jk_bw:load/settings/menu/teams/bed/blue"}},"  ",{"text":"[绿队]","color":"green","clickEvent":{"action":"run_command","value":"/function jk_bw:load/settings/menu/teams/bed/green"}},"  ",{"text":"[黄队]","color":"yellow","clickEvent":{"action":"run_command","value":"/function jk_bw:load/settings/menu/teams/bed/yellow"}},{"text":"  [提示]","color":"gray","hoverEvent":{"action":"show_text","value":"若在游戏结束后发现床不在标记点请无视。"}}]

execute if score #teams jk_bw_mem matches 2 run tellraw @a[tag=jk_bw_admin] ["\n设置出生点：",{"text":"[红队]","color":"red","clickEvent":{"action":"run_command","value":"/function jk_bw:load/settings/menu/teams/spawn/red"}},"  ",{"text":"[蓝队]","color":"blue","clickEvent":{"action":"run_command","value":"/function jk_bw:load/settings/menu/teams/spawn/blue"}},{"text":"  [提示]","color":"gray","hoverEvent":{"action":"show_text","value":"出生点半径 3 格无法搭建方块， 玩家出生朝向为你的当前朝向。"}}]
execute if score #teams jk_bw_mem matches 4 run tellraw @a[tag=jk_bw_admin] ["\n设置出生点：",{"text":"[红队]","color":"red","clickEvent":{"action":"run_command","value":"/function jk_bw:load/settings/menu/teams/spawn/red"}},"  ",{"text":"[蓝队]","color":"blue","clickEvent":{"action":"run_command","value":"/function jk_bw:load/settings/menu/teams/spawn/blue"}},"  ",{"text":"[绿队]","color":"green","clickEvent":{"action":"run_command","value":"/function jk_bw:load/settings/menu/teams/spawn/green"}},"  ",{"text":"[黄队]","color":"yellow","clickEvent":{"action":"run_command","value":"/function jk_bw:load/settings/menu/teams/spawn/yellow"}},{"text":"  [提示]","color":"gray","hoverEvent":{"action":"show_text","value":"出生点半径 3 格无法搭建方块， 玩家出生朝向为你的当前朝向。"}}]
...
tellraw @a[tag=jk_bw_admin] ["\n出生资源点：",{"text":"[添加]","color":"light_purple","clickEvent":{"action":"run_command","value":"/function jk_bw:load/settings/menu/res/spawn"},"hoverEvent":{"action":"show_text","contents":"包含一个金点，三个铁点\n请在设置完队伍出生点之后使用！"}},"  ",{"text":"[清除]","color":"gray","clickEvent":{"action":"run_command","value":"/function jk_bw:load/settings/menu/res/spawn_clear"}},"  ",{"text":"[提示]","color":"gray","hoverEvent":{"action":"show_text","contents":["请保证",{"text":"金点","color":"yellow","underlined":true},"在团队出生点的 ",{"text":"8","color":"red","bold":true}," 格范围内！"]}}]

tellraw @a[tag=jk_bw_admin] ["\n商店设置：",{"text":"[物品商店]","color":"yellow","clickEvent":{"action":"run_command","value":"/function jk_bw:load/settings/menu/shop/item_"}},"  ",{"text":"[团队商店]","color":"aqua","clickEvent":{"action":"run_command","value":"/function jk_bw:load/settings/menu/shop/team"}}]

tellraw @a[tag=jk_bw_admin] ["\n",{"text":"[清除所有]","color":"gray","clickEvent":{"action":"run_command","value":"/function jk_bw:load/settings/menu/teams/clear"},"hoverEvent":{"action":"show_text","contents":"即清理所有的床点/出生点/出生资源点/箱子点！"}},"  ",{"text":"[返回主菜单]","color":"green","clickEvent":{"action":"run_command","value":"/function jk_bw:load/settings/menu"}},"  ",{"text":"[测试模式]","color":"red","bold":true,"clickEvent":{"action":"run_command","value":"/function jk_bw:load/settings/menu/test_mode"},"hoverEvent":{"action":"show_text","contents":[{"text":"要开启，请把","color":"yellow"},{"text":"红队","color":"red","bold":true},"的",{"text":"出生点和床点","color":"aqua"},{"text":"放好！","color":"yellow"}]}}]