...
execute as @s[y_rotation=-44.9..45] run summon armor_stand ~1 ~2 ~ {Tags:["jk_bw","jk_bw_point","jk_bw_iron_time","jk_bw_res_time"],Marker:true,CustomName:'[{"text":"此处为铁资源点"}]',CustomNameVisible:true,Small:true,Invisible:true}
execute as @s[y_rotation=-44.9..45] run summon armor_stand ~-1 ~2 ~ {Tags:["jk_bw","jk_bw_point","jk_bw_iron_time","jk_bw_res_time"],Marker:true,CustomName:'[{"text":"此处为铁资源点"}]',CustomNameVisible:true,Small:true,Invisible:true}
execute as @s[y_rotation=135.1..180] run summon armor_stand ~1 ~2 ~ {Tags:["jk_bw","jk_bw_point","jk_bw_iron_time","jk_bw_res_time"],Marker:true,CustomName:'[{"text":"此处为铁资源点"}]',CustomNameVisible:true,Small:true,Invisible:true}
execute as @s[y_rotation=135.1..180] run summon armor_stand ~-1 ~2 ~ {Tags:["jk_bw","jk_bw_point","jk_bw_iron_time","jk_bw_res_time"],Marker:true,CustomName:'[{"text":"此处为铁资源点"}]',CustomNameVisible:true,Small:true,Invisible:true}
execute as @s[y_rotation=-179.9..-135] run summon armor_stand ~1 ~2 ~ {Tags:["jk_bw","jk_bw_point","jk_bw_iron_time","jk_bw_res_time"],Marker:true,CustomName:'[{"text":"此处为铁资源点"}]',CustomNameVisible:true,Small:true,Invisible:true}
execute as @s[y_rotation=-179.9..-135] run summon armor_stand ~-1 ~2 ~ {Tags:["jk_bw","jk_bw_point","jk_bw_iron_time","jk_bw_res_time"],Marker:true,CustomName:'[{"text":"此处为铁资源点"}]',CustomNameVisible:true,Small:true,Invisible:true}
execute as @s[y_rotation=-134.9..-45] run summon armor_stand ~ ~2 ~1 {Tags:["jk_bw","jk_bw_point","jk_bw_iron_time","jk_bw_res_time"],Marker:true,CustomName:'[{"text":"此处为铁资源点"}]',CustomNameVisible:true,Small:true,Invisible:true}
execute as @s[y_rotation=-134.9..-45] run summon armor_stand ~ ~2 ~-1 {Tags:["jk_bw","jk_bw_point","jk_bw_iron_time","jk_bw_res_time"],Marker:true,CustomName:'[{"text":"此处为铁资源点"}]',CustomNameVisible:true,Small:true,Invisible:true}
execute as @s[y_rotation=45.1..135] run summon armor_stand ~ ~2 ~1 {Tags:["jk_bw","jk_bw_point","jk_bw_iron_time","jk_bw_res_time"],Marker:true,CustomName:'[{"text":"此处为铁资源点"}]',CustomNameVisible:true,Small:true,Invisible:true}
execute as @s[y_rotation=45.1..135] run summon armor_stand ~ ~2 ~-1 {Tags:["jk_bw","jk_bw_point","jk_bw_iron_time","jk_bw_res_time"],Marker:true,CustomName:'[{"text":"此处为铁资源点"}]',CustomNameVisible:true,Small:true,Invisible:true}
