...
# 检查有无资格使用测试模式
scoreboard players reset #test_check jk_bw_mem
execute if entity @e[limit=1,tag=jk_bw_bed_red] run scoreboard players set #test_check jk_bw_mem 1
execute if entity @e[limit=1,tag=jk_bw_spawn_red] if score #test_check jk_bw_mem matches 1 run scoreboard players set #test_check jk_bw_mem 2
# 检查通过
execute if score #test_check jk_bw_mem matches 2 run scoreboard players add #test_mode jk_bw_mem 1
