...
execute as @s[team=jkbw.blue] as @e[limit=1,tag=jkbw_spawn_blue] at @s run playsound minecraft:block.beacon.activate player @a[distance=..2]
execute as @s[team=jkbw.green] as @e[limit=1,tag=jkbw_spawn_green] at @s run playsound minecraft:block.beacon.activate player @a[distance=..2]
execute as @s[team=jkbw.yellow] as @e[limit=1,tag=jkbw_spawn_yellow] at @s run playsound minecraft:block.beacon.activate player @a[distance=..2]