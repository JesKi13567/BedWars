...
execute unless score #exp_mode jkbw.mem matches 1 if score #res_mode jkbw.mem matches 2 run tellraw @a ["", {"translate": "attribute.name.generic.max_health"}, " ", {"storage": "jk:bw", "nbt": "txt.print.now_become"}, " ", {"text": "60", "color": "red"}, "."]
