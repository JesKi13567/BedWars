...
execute as @s[scores={jkbw.mem=0}] unless entity @e[tag=jkbw_extra_gold,distance=...2] run summon item ~ ~ ~ {Age: -32768, PickupDelay: 18, Invulnerable: 1, Item: {id: "gold_ingot", Count: 1, tag: {CanDestroy: ["#jkbw:candestroy"], HideFlags: 28}}, Tags: ["jkbw", "jkbw_res_summon", "jkbw_res_gold"], NoGravity: 1b}
