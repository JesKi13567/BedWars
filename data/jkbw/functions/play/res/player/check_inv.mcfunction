...
# 清理
execute as @e[type=item, tag=jkbw_commonkill_item] unless data entity @s Item{id: "minecraft:iron_ingot"} unless data entity @s Item{id: "minecraft:gold_ingot"} unless data entity @s Item{id: "minecraft:diamond"} unless data entity @s Item{id: "minecraft:emerald"} run kill @s
