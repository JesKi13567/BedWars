...
# 成功购买
give @s[tag=jkbw_buy_success] endermite_spawn_egg{CanDestroy: ["#jkbw:candestroy"], CanPlaceOn: ["#jkbw:canplaceon"], EntityTag: {id: "marker", Tags:["jkbw", "jkbw_chest_player", "jkbw_new_entity"]}, display: {Name:'{"translate": "block.minecraft.ender_chest", "color": "white", "italic": false}'}, HideFlags: 24}
