...
tellraw @s[tag=!jkbw_buy_success] [{"text":"无法购买","color":"red"},{"text":" 钻石头盔 ","color":"yellow"},"*1，你还需要 ",{"score":{"name": "#shop_temp","objective":"jkbw.mem"},"color":"yellow"}," 点经验！"]
...
tellraw @s[tag=jkbw_buy_success] [{"text":"成功购买","color":"green"},{"text":" 钻石头盔 ","color":"gold"},"*1！"]
