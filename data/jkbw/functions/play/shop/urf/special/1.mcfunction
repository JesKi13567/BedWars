...
# 成功购买
$execute if score #1 jkbw.mem matches $(id) run give @s[tag=jkbw_buy_success] blaze_rod{CanDestroy: ["#jkbw:candestroy"], jkbw: ["offhand_use"], HideFlags: 24}
...
$execute if score #4 jkbw.mem matches $(id) run give @s[tag=jkbw_buy_success] ice{CanDestroy: ["#jkbw:candestroy"], jkbw: ["offhand_use"], HideFlags: 24}
$execute if score #5 jkbw.mem matches $(id) run give @s[tag=jkbw_buy_success] paper{CanDestroy: ["#jkbw:candestroy"], jkbw: ["offhand_use"], HideFlags: 24}
$execute if score #6 jkbw.mem matches $(id) run give @s[tag=jkbw_buy_success] prismarine_shard{CanDestroy: ["#jkbw:candestroy"], jkbw: ["offhand_use"], HideFlags: 24}
$execute if score #7 jkbw.mem matches $(id) run give @s[tag=jkbw_buy_success] egg{CanDestroy: ["#jkbw:candestroy"], HideFlags: 24}
