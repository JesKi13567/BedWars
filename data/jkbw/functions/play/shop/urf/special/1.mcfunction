...
$execute if score #8 jkbw.mem matches $(id) run give @s[tag=jkbw_buy_success] amethyst_shard{CanDestroy: ["#jkbw:candestroy"], CanPlaceOn: ["#jkbw:canplaceon"], HideFlags: 24}
