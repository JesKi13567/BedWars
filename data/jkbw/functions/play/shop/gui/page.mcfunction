...
execute if score #shop_mode jkbw.mem matches 0..1 run scoreboard players set @s[nbt=!{EnderItems: [{tag: {jkbw: ["shop", "page", "-1"]}}]}] jkbw.Player.Page -1
...
execute if score #shop_mode jkbw.mem matches 0..1 run item replace entity @s[scores={jkbw.Player.Page=-1}] enderchest.4 from block 10110223 4 10110223 container.4
