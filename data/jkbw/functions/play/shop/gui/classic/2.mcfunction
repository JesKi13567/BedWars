...
item replace entity @s enderchest.13 from block 10110223 5 10110223 container.13
...
# 单/双人模式TNT价格修改了
execute if score #multi_mode jkbw.mem matches 1 run item replace entity @s enderchest.13 from block 10110223 5 10110223 container.0