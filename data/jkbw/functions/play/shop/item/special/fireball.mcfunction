...
# 成功购买
give @s[tag=jkbw_buy_success] fire_charge{CanDestroy: ["#jkbw:candestroy"], display: {Lore: ['""', '{"text":"触碰到方块即爆炸，可破坏羊毛与木板！","italic":false,"color":"gold"}', '{"text":"主手拿着潜行，发射一个恶魂火球。","italic":false,"color":"gray"}']}, HideFlags: 28}
