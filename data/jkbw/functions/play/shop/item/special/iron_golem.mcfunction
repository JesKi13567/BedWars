...
# 成功购买
give @s[tag=jkbw_buy_success,team=jkbw.red] iron_golem_spawn_egg{display: {Name: '{"text":"梦境守护者","color":"white","italic":false}', Lore: ['""', '{"text":"生成铁傀儡，","italic":false,"color":"gold"}', '{"text":"为你的团队战斗 120 秒！","italic":false,"color":"aqua"}']}, CanPlaceOn: ["#jkbw:canplaceon"], CanDestroy: ["#jkbw:candestroy"], EntityTag: {id: "minecraft:iron_golem", Tags: ["jkbw", "jkbw_new_creature", "jkbw_iron_golem"], CustomName: '{"text":"梦境守护者"}', CustomNameVisible: true, Health: 100.0f, Team: "jkbw.red"}, HideFlags: 28}
give @s[tag=jkbw_buy_success,team=jkbw.blue] iron_golem_spawn_egg{display: {Name: '{"text":"梦境守护者","color":"white","italic":false}', Lore: ['""', '{"text":"生成铁傀儡，","italic":false,"color":"gold"}', '{"text":"为你的团队战斗 120 秒！","italic":false,"color":"aqua"}']}, CanPlaceOn: ["#jkbw:canplaceon"], CanDestroy: ["#jkbw:candestroy"], EntityTag: {id: "minecraft:iron_golem", Tags: ["jkbw", "jkbw_new_creature", "jkbw_iron_golem"], CustomName: '{"text":"梦境守护者"}', CustomNameVisible: true, Health: 100.0f, Team: "jkbw.blue"}, HideFlags: 28}
give @s[tag=jkbw_buy_success,team=jkbw.green] iron_golem_spawn_egg{display: {Name: '{"text":"梦境守护者","color":"white","italic":false}', Lore: ['""', '{"text":"生成铁傀儡，","italic":false,"color":"gold"}', '{"text":"为你的团队战斗 120 秒！","italic":false,"color":"aqua"}']}, CanPlaceOn: ["#jkbw:canplaceon"], CanDestroy: ["#jkbw:candestroy"], EntityTag: {id: "minecraft:iron_golem", Tags: ["jkbw", "jkbw_new_creature", "jkbw_iron_golem"], CustomName: '{"text":"梦境守护者"}', CustomNameVisible: true, Health: 100.0f, Team: "jkbw.green"}, HideFlags: 28}
give @s[tag=jkbw_buy_success,team=jkbw.yellow] iron_golem_spawn_egg{display: {Name: '{"text":"梦境守护者","color":"white","italic":false}', Lore: ['""', '{"text":"生成铁傀儡，","italic":false,"color":"gold"}', '{"text":"为你的团队战斗 120 秒！","italic":false,"color":"aqua"}']}, CanPlaceOn: ["#jkbw:canplaceon"], CanDestroy: ["#jkbw:candestroy"], EntityTag: {id: "minecraft:iron_golem", Tags: ["jkbw", "jkbw_new_creature", "jkbw_iron_golem"], CustomName: '{"text":"梦境守护者"}', CustomNameVisible: true, Health: 100.0f, Team: "jkbw.yellow"}, HideFlags: 28}
