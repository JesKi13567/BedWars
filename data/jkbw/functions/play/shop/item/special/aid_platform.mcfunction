...
# 成功购买
give @s[tag=jkbw_buy_success] blaze_rod{display: {Name: '{"text":"急救平台","color":"white","italic":false}', Lore: ['""', '{"text":"主手使用，在下方 3 格处生成粘液块平台，维持 10 秒！","italic":false,"color":"gold"}']}, CanPlaceOn: ["#jkbw:canplaceon"], CanDestroy: ["#jkbw:candestroy"], HideFlags: 28, jkbw: ["offhand_use"]}
