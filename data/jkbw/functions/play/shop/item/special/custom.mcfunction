...
$execute if score #2 jkbw.mem matches $(id) run give @s[tag=jkbw_buy_success] snowball{CanDestroy: ["#jkbw:candestroy"], CanPlaceOn: ["#jkbw:canplaceon"], display: {Name: '{"translate": "item.minecraft.silverfish_spawn_egg", "color": "white", "italic": false}'}, HideFlags: 24}
...
$execute if score #6 jkbw.mem matches $(id) run give @s[tag=jkbw_buy_success] egg{CanDestroy: ["#jkbw:candestroy"], CanPlaceOn: ["#jkbw:canplaceon"], HideFlags: 24}
$execute if score #7 jkbw.mem matches $(id) run give @s[tag=jkbw_buy_success] blaze_rod{CanDestroy: ["#jkbw:candestroy"], CanPlaceOn: ["#jkbw:canplaceon"], jkbw: ["offhand_use"], HideFlags: 24}
$execute if score #8 jkbw.mem matches $(id) run give @s[tag=jkbw_buy_success] crossbow{jkbw: ["max_crossbow"], CanDestroy: ["#jkbw:candestroy"], CanPlaceOn: ["#jkbw:canplaceon"], Enchantments: [{id: "quick_charge", lvl: 5}], Unbreakable: True, HideFlags: 24}
$execute if score #9 jkbw.mem matches $(id) run give @s[tag=jkbw_buy_success] ice{CanDestroy: ["#jkbw:candestroy"], CanPlaceOn: ["#jkbw:canplaceon"], jkbw: ["offhand_use"], HideFlags: 24}
