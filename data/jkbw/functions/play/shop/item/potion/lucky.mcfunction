...
execute unless score #exp_mode jkbw.mem matches 1 run tellraw @s[tag=!jkbw_buy_success] [{"text":"无法购买","color":"red"},{"text":" 魔法药水","color":"yellow","bold":true},"，你还需要 ",{"score":{"name": "#shop_temp","objective":"jkbw.mem"},"color":"yellow"}," 块金锭！"]
execute if score #exp_mode jkbw.mem matches 1 run tellraw @s[tag=!jkbw_buy_success] [{"text":"无法购买","color":"red"},{"text":" 魔法药水","color":"yellow","bold":true},"，你还需要 ",{"score":{"name": "#shop_temp","objective":"jkbw.mem"},"color":"yellow"}," 点经验！"]
playsound entity.villager.no player @s[tag=!jkbw_buy_success]

# 成功购买
give @s[tag=jkbw_buy_success] potion{CustomPotionColor:2855694,display:{Name:'{"text":"魔法药水","color":"white","italic":false}',Lore:['""','{"text":"饮用后 30 秒内不会触发陷阱！","italic":false,"color":"gold"}','{"text":"给你一瓶魔法药水~","color":"gray"}']},Potion:"water",CustomPotionEffects:[{Id:26,Amplifier:0,Duration:600,ShowParticles:false}],CanPlaceOn:["#jkbw:canplaceon"],CanDestroy:["#jkbw:candestroy"],HideFlags:28}
tellraw @s[tag=jkbw_buy_success] [{"text":"成功购买","color":"green"},{"text":" 魔法药水","color":"gold","bold":true},"！"]
