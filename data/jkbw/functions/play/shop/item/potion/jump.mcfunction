...
# 成功购买
give @s[tag=jkbw_buy_success] potion{CustomPotionColor:1231137,display:{Name:'{"text":"跳跃提升 V 药水（45 秒）","color":"green","italic":false}'},Potion:"water",CustomPotionEffects:[{Id:8,Amplifier:4,Duration:900,ShowParticles:false}],CanPlaceOn:["#jkbw:canplaceon"],CanDestroy:["#jkbw:candestroy"],HideFlags:28}
