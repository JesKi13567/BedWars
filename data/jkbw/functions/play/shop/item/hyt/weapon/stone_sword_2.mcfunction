...
# 成功购买
give @s[tag=jkbw_buy_success] stone_sword{display:{Name:'"石剑·二级"'},CanPlaceOn:["#jkbw:canplaceon"],CanDestroy:["#jkbw:candestroy"],AttributeModifiers:[{Name:"a",AttributeName:"generic.attack_damage",UUID:[I;1,1,1,1],Slot:"mainhand",Operation:0,Amount:6.5}],HideFlags:28} 1
tellraw @s[tag=jkbw_buy_success] [{"text":"成功购买","color":"green"},{"text":" 石剑·二级 ","color":"gold","bold":true},"*1！"]
