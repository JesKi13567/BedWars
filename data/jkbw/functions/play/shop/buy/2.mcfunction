...
execute if entity @e[tag=jkbw_bed_green,scores={jkbw.Team.Alive=1..}] if entity @p[team=jkbw.green,gamemode=adventure] as @s[team=!jkbw.green,nbt=!{EnderItems: [{tag: {jkbw: ["compass", "green"]}}]}] run function jkbw:play/shop/compass/green
execute if entity @e[tag=jkbw_bed_yellow,scores={jkbw.Team.Alive=1..}] if entity @p[team=jkbw.yellow,gamemode=adventure] as @s[team=!jkbw.yellow,nbt=!{EnderItems: [{tag: {jkbw: ["compass", "yellow"]}}]}] run function jkbw:play/shop/compass/yellow