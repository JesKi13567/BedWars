...
# 购买不成功，计算差价
execute unless score #exp_mode jkbw.mem matches 1 as @s[tag=!jkbw_team_enough_trap,tag=!jkbw_buy_success] run scoreboard players operation #shop_temp jkbw.mem = @s jkbw.Player.OwnDiamonds
execute unless score #exp_mode jkbw.mem matches 1 as @s[tag=!jkbw_team_enough_trap,tag=!jkbw_buy_success,team=jkbw.red] if entity @e[tag=jkbw_bed_red,limit=1,scores={jkbw.Team.TrapNum=0}] run scoreboard players remove #shop_temp jkbw.mem 1
execute unless score #exp_mode jkbw.mem matches 1 as @s[tag=!jkbw_team_enough_trap,tag=!jkbw_buy_success,team=jkbw.red] if entity @e[tag=jkbw_bed_red,limit=1,scores={jkbw.Team.TrapNum=1}] run scoreboard players remove #shop_temp jkbw.mem 2
execute unless score #exp_mode jkbw.mem matches 1 as @s[tag=!jkbw_team_enough_trap,tag=!jkbw_buy_success,team=jkbw.red] if entity @e[tag=jkbw_bed_red,limit=1,scores={jkbw.Team.TrapNum=2}] run scoreboard players remove #shop_temp jkbw.mem 4
execute unless score #exp_mode jkbw.mem matches 1 as @s[tag=!jkbw_team_enough_trap,tag=!jkbw_buy_success,team=jkbw.blue] if entity @e[tag=jkbw_bed_blue,limit=1,scores={jkbw.Team.TrapNum=0}] run scoreboard players remove #shop_temp jkbw.mem 1
execute unless score #exp_mode jkbw.mem matches 1 as @s[tag=!jkbw_team_enough_trap,tag=!jkbw_buy_success,team=jkbw.blue] if entity @e[tag=jkbw_bed_blue,limit=1,scores={jkbw.Team.TrapNum=1}] run scoreboard players remove #shop_temp jkbw.mem 2
execute unless score #exp_mode jkbw.mem matches 1 as @s[tag=!jkbw_team_enough_trap,tag=!jkbw_buy_success,team=jkbw.blue] if entity @e[tag=jkbw_bed_blue,limit=1,scores={jkbw.Team.TrapNum=2}] run scoreboard players remove #shop_temp jkbw.mem 4
execute unless score #exp_mode jkbw.mem matches 1 as @s[tag=!jkbw_team_enough_trap,tag=!jkbw_buy_success,team=jkbw.green] if entity @e[tag=jkbw_bed_green,limit=1,scores={jkbw.Team.TrapNum=0}] run scoreboard players remove #shop_temp jkbw.mem 1
execute unless score #exp_mode jkbw.mem matches 1 as @s[tag=!jkbw_team_enough_trap,tag=!jkbw_buy_success,team=jkbw.green] if entity @e[tag=jkbw_bed_green,limit=1,scores={jkbw.Team.TrapNum=1}] run scoreboard players remove #shop_temp jkbw.mem 2
execute unless score #exp_mode jkbw.mem matches 1 as @s[tag=!jkbw_team_enough_trap,tag=!jkbw_buy_success,team=jkbw.green] if entity @e[tag=jkbw_bed_green,limit=1,scores={jkbw.Team.TrapNum=2}] run scoreboard players remove #shop_temp jkbw.mem 4
execute unless score #exp_mode jkbw.mem matches 1 as @s[tag=!jkbw_team_enough_trap,tag=!jkbw_buy_success,team=jkbw.yellow] if entity @e[tag=jkbw_bed_yellow,limit=1,scores={jkbw.Team.TrapNum=0}] run scoreboard players remove #shop_temp jkbw.mem 1
execute unless score #exp_mode jkbw.mem matches 1 as @s[tag=!jkbw_team_enough_trap,tag=!jkbw_buy_success,team=jkbw.yellow] if entity @e[tag=jkbw_bed_yellow,limit=1,scores={jkbw.Team.TrapNum=1}] run scoreboard players remove #shop_temp jkbw.mem 2
execute unless score #exp_mode jkbw.mem matches 1 as @s[tag=!jkbw_team_enough_trap,tag=!jkbw_buy_success,team=jkbw.yellow] if entity @e[tag=jkbw_bed_yellow,limit=1,scores={jkbw.Team.TrapNum=2}] run scoreboard players remove #shop_temp jkbw.mem 4
