...
execute unless score #multi_mode jkbw.mem matches 1 if score #exp_mode jkbw.mem matches 0 as @s[tag=!jkbw_buy_success] run scoreboard players remove #shop_temp jkbw.mem 4
...
execute if score #exp_mode jkbw.mem matches 0 run tellraw @s[tag=!jkbw_buy_success] [{"text":"无法购买","color":"red"},{"text":" 急迫 I","color":"yellow","bold":true},"，你还需要 ",{"score":{"name": "#shop_temp","objective":"jkbw.mem"},"color":"yellow"}," 块钻石！"]
execute if score #exp_mode jkbw.mem matches 1 run tellraw @s[tag=!jkbw_buy_success] [{"text":"无法购买","color":"red"},{"text":" 急迫 I","color":"yellow","bold":true},"，你还需要 ",{"score":{"name": "#shop_temp","objective":"jkbw.mem"},"color":"yellow"}," 点经验！"]
...
execute as @s[team=jkbw.red,tag=jkbw_buy_success] run tellraw @a[team=jkbw.red] [{"selector":"@s"},{"text":"购买了","color":"green"},{"text":"急迫 I","color":"gold","bold":true}]
execute as @s[team=jkbw.blue,tag=jkbw_buy_success] run tellraw @a[team=jkbw.blue] [{"selector":"@s"},{"text":"购买了","color":"green"},{"text":"急迫 I","color":"gold","bold":true}]
execute as @s[team=jkbw.green,tag=jkbw_buy_success] run tellraw @a[team=jkbw.green] [{"selector":"@s"},{"text":"购买了","color":"green"},{"text":"急迫 I","color":"gold","bold":true}]
execute as @s[team=jkbw.yellow,tag=jkbw_buy_success] run tellraw @a[team=jkbw.yellow] [{"selector":"@s"},{"text":"购买了","color":"green"},{"text":"急迫 I","color":"gold","bold":true}]

playsound entity.experience_orb.pickup player @s[tag=jkbw_buy_success]
execute unless score #multi_mode jkbw.mem matches 1 if score #exp_mode jkbw.mem matches 0 as @s[tag=jkbw_buy_success] run clear @s[tag=jkbw_buy_success] diamond 4
execute if score #multi_mode jkbw.mem matches 1 if score #exp_mode jkbw.mem matches 0 as @s[tag=jkbw_buy_success] run clear @s[tag=jkbw_buy_success] diamond 2
