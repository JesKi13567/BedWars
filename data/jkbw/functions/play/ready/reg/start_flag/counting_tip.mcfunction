...
execute if score #teams jkbw.mem matches 5..6 if score #reg_num jkbw.mem matches 61.. run tellraw @a [{"storage": "jk:bw", "nbt": "txt.print.bedwars", "color": "yellow"}, " ", {"storage": "jk:bw", "nbt": "txt.print.start_full", "color": "green"}]
