...
# 显示
title @s[scores={jkbw.Player.Compass=-1}] actionbar [{"storage": "jk:bw", "nbt": "txt.compass.track", "color": "gold"}, {"storage": "jk:bw", "nbt": "txt.compass.enemy"}, ": ", {"score": {"name": "@s", "objective": "jkbw.Entity.X"}, "color": "green"}, {"text": ".", "color": "green"}, {"score": {"name": "@s", "objective": "jkbw.Entity.Z"}, "color": "green"}, "m"]
title @s[scores={jkbw.Player.Compass=0}] actionbar [{"storage": "jk:bw", "nbt": "txt.compass.track", "color": "gold"}, {"storage": "jk:bw", "nbt": "txt.print.bed"}, ": ", {"score": {"name": "@s", "objective": "jkbw.Entity.X"}, "color": "green"}, {"text": ".", "color": "green"}, {"score": {"name": "@s", "objective": "jkbw.Entity.Z"}, "color": "green"}, "m"]
