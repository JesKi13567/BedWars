...
give @s[scores={jkbw.Player.HasCompass=0},team=jkbw.red] compass{display:{Name:'"红队指南针"',Lore:['{"text":"开启自家队伍箱的钥匙，","color":"gray","italic":false}','{"text":"被团灭队伍不需要钥匙解锁。","color":"gray","italic":false}','{"text":"拿主手上显示距离。","color":"gray","italic":false}']},CanDestroy:["#jkbw:candestroy"],HideFlags:28,jkbw_clean:1}
give @s[scores={jkbw.Player.HasCompass=0},team=jkbw.blue] compass{display:{Name:'"蓝队指南针"',Lore:['{"text":"开启自家队伍箱的钥匙，","color":"gray","italic":false}','{"text":"被团灭队伍不需要钥匙解锁。","color":"gray","italic":false}','{"text":"拿主手上显示距离。","color":"gray","italic":false}']},CanDestroy:["#jkbw:candestroy"],HideFlags:28,jkbw_clean:1}
give @s[scores={jkbw.Player.HasCompass=0},team=jkbw.green] compass{display:{Name:'"绿队指南针"',Lore:['{"text":"开启自家队伍箱的钥匙，","color":"gray","italic":false}','{"text":"被团灭队伍不需要钥匙解锁。","color":"gray","italic":false}','{"text":"拿主手上显示距离。","color":"gray","italic":false}']},CanDestroy:["#jkbw:candestroy"],HideFlags:28,jkbw_clean:1}
give @s[scores={jkbw.Player.HasCompass=0},team=jkbw.yellow] compass{display:{Name:'"黄队指南针"',Lore:['{"text":"开启自家队伍箱的钥匙，","color":"gray","italic":false}','{"text":"被团灭队伍不需要钥匙解锁。","color":"gray","italic":false}','{"text":"拿主手上显示距离。","color":"gray","italic":false}']},CanDestroy:["#jkbw:candestroy"],HideFlags:28,jkbw_clean:1}