...
item replace entity @s[scores={jkbw.Player.TeamSelect=1},tag=jkbw_registered] armor.head with leather_helmet{HideFlags: 1023, display: {color: 11546150, Name: '[{"text": "已选择","color": "white","italic": false}," ",{"text": "红队","bold": true,"color": "red"}]'}, jkbw: ["team_color", "red"], Enchantments: [{id: "infinity", lvl: 1s}, {id: "binding_curse", lvl: 1s}]}
item replace entity @s[scores={jkbw.Player.TeamSelect=2},tag=jkbw_registered] armor.head with leather_helmet{HideFlags: 1023, display: {color: 3949738, Name: '[{"text": "已选择","color": "white","italic": false}," ",{"text": "蓝队","bold": true,"color": "blue"}]'}, jkbw: ["team_color", "blue"], Enchantments: [{id: "infinity", lvl: 1s}, {id: "binding_curse", lvl: 1s}]}
item replace entity @s[scores={jkbw.Player.TeamSelect=3},tag=jkbw_registered] armor.head with leather_helmet{HideFlags: 1023, display: {color: 6192150, Name: '[{"text": "已选择","color": "white","italic": false}," ",{"text": "绿队","bold": true,"color": "green"}]'}, jkbw: ["team_color", "green"], Enchantments: [{id: "infinity", lvl: 1s}, {id: "binding_curse", lvl: 1s}]}
item replace entity @s[scores={jkbw.Player.TeamSelect=4},tag=jkbw_registered] armor.head with leather_helmet{HideFlags: 1023, display: {color: 16701501, Name: '[{"text": "已选择","color": "white","italic": false}," ",{"text": "黄队","bold": true,"color": "yellow"}]'}, jkbw: ["team_color", "yellow"], Enchantments: [{id: "infinity", lvl: 1s}, {id: "binding_curse", lvl: 1s}]}