...
execute align xyz run summon text_display ~.5 ~.5 ~.5 {Tags:["jkbw_bed_green","jkbw_bed_marker","jkbw"],text:'[{"text":"绿队床位","color":"green"}]',billboard:"center",line_width:200,transformation:{scale:[1f,1f,1f]}}
