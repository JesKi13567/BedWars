...
execute align xyz run summon text_display ~.5 ~.5 ~.5 {Tags:["jkbw_bed_blue","jkbw_bed_marker","jkbw"],text:'[{"text":"蓝队床位","color":"blue"}]',billboard:"center",line_width:200,transformation:{scale:[1f,1f,1f]}}
