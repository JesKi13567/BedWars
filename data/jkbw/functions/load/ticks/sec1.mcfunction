...
execute if score #state jkbw.mem matches 0 run title @a[gamemode=creative] actionbar [{"storage": "jk:bw", "nbt": "txt.print.current", "color": "green"}, {"translate": "item.minecraft.filled_map", "color": "green"}, ": ", {"storage": "jk:bw", "nbt": "Map.cur.id", "color": "gold"}]
