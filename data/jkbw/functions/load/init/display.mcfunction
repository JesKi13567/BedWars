...
tellraw @a [{"text":"\n\n【⭐起床战争⭐】","color":"yellow"},{"text":"本局资源：","color":"green"},{"selector":"@e[limit=1,tag=jkbw_display_exp]"},{"text":"， 攻击速度：","color":"green"},{"selector":"@e[limit=1,tag=jkbw_display_attack]"},{"text":"， 每队人数：","color":"green"},{"selector":"@e[limit=1,tag=jkbw_display_multi]"},"\n【⭐起床战争⭐】",{"text":"指南针开团队箱子，","bold":true,"italic":false,"color":"red"},{"text":"拿着物品破坏方块！","bold":true,"italic":false,"color":"red"}]
