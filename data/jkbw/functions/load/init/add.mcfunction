...
scoreboard objectives add jkbw.Player.Chest dummy "玩家末影箱编号"
scoreboard objectives add jkbw.Player.Page dummy "玩家末影箱页数"
scoreboard objectives add jkbw.Player.Distance dummy "玩家距离编号"
...
scoreboard objectives add jkbw.Player.UseIrongolem minecraft.used:polar_bear_spawn_egg "玩家使用铁傀儡蛋"
...
scoreboard objectives add jkbw.Player.UUID dummy "玩家UUID"
...
# bossbar
function jkbw:load/init/bossbar
...
# 游戏规则
function jkbw:load/init/gamerule