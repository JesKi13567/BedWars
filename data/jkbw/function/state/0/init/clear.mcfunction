...
scoreboard objectives remove jkbw.Team.Select
scoreboard objectives remove jkbw.Team.Trap.1
scoreboard objectives remove jkbw.Team.Trap.2
...
scoreboard objectives remove jkbw.Player.Break.Bed.blue
scoreboard objectives remove jkbw.Player.Break.Bed.cyan
scoreboard objectives remove jkbw.Player.Break.Bed.gray
scoreboard objectives remove jkbw.Player.Break.Bed.green
scoreboard objectives remove jkbw.Player.Break.Bed.pink
scoreboard objectives remove jkbw.Player.Break.Bed.red
scoreboard objectives remove jkbw.Player.Break.Bed.white
scoreboard objectives remove jkbw.Player.Break.Bed.yellow
scoreboard objectives remove jkbw.Player.Break.Cake.blue
scoreboard objectives remove jkbw.Player.Break.Cake.cyan
scoreboard objectives remove jkbw.Player.Break.Cake.gray
scoreboard objectives remove jkbw.Player.Break.Cake.green
scoreboard objectives remove jkbw.Player.Break.Cake.pink
scoreboard objectives remove jkbw.Player.Break.Cake.red
scoreboard objectives remove jkbw.Player.Break.Cake.white
scoreboard objectives remove jkbw.Player.Break.Cake.yellow
scoreboard objectives remove jkbw.Player.Compass
scoreboard objectives remove jkbw.Player.Damage.Source.last
scoreboard objectives remove jkbw.Player.Damage.Source.now
scoreboard objectives remove jkbw.Player.Damage.Source.real
scoreboard objectives remove jkbw.Player.Damage.Temp
scoreboard objectives remove jkbw.Player.Damage.Type.last
scoreboard objectives remove jkbw.Player.Damage.Type.now
...
scoreboard objectives remove jkbw.Player.Levels.pickaxe
scoreboard objectives remove jkbw.Player.Levels.shears
...
scoreboard objectives remove jkbw.Player.Own.iron_ingot
...
scoreboard objectives remove jkbw.Player.Place.Blue
scoreboard objectives remove jkbw.Player.Place.Cyan
scoreboard objectives remove jkbw.Player.Place.Gray
scoreboard objectives remove jkbw.Player.Place.Green
scoreboard objectives remove jkbw.Player.Place.Orange
scoreboard objectives remove jkbw.Player.Place.Pink
...
scoreboard objectives remove jkbw.Player.Use.CD.AntiArrow
...
scoreboard objectives remove jkbw.Player.Use.Egg
scoreboard objectives remove jkbw.Player.Use.Enderchest
...
scoreboard objectives remove jkbw.Res.Count.Iron
scoreboard objectives remove jkbw.Res.Count.diamond
scoreboard objectives remove jkbw.Res.Count.emerald
