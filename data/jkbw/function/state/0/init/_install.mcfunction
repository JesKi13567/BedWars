...
scoreboard objectives add jkbw.Team.deadshot dummy "队伍升级-致命射击"
scoreboard objectives add jkbw.Team.dragon dummy "队伍升级-死斗"
scoreboard objectives add jkbw.Team.haste dummy "队伍升级-急迫效果"
scoreboard objectives add jkbw.Team.healing dummy "队伍升级-治愈池"
scoreboard objectives add jkbw.Team.knockback dummy "队伍升级-击退附魔"
scoreboard objectives add jkbw.Team.protect dummy "队伍升级-保护附魔"
scoreboard objectives add jkbw.Team.res dummy "队伍升级-资源点"
scoreboard objectives add jkbw.Team.sharpness dummy "队伍升级-锋利附魔"
...
scoreboard objectives add jkbw.Player.Compass dummy "玩家指南针模式"
...
scoreboard objectives add jkbw.Player.Ray dummy "玩家视线距离"
scoreboard objectives add jkbw.Player.RebornTime dummy "玩家复活倒计时"
scoreboard objectives add jkbw.Player.ShopNow dummy "玩家使用-商店"
scoreboard objectives add jkbw.Player.ShopRandom dummy "玩家随机商店值"
scoreboard objectives add jkbw.Player.State dummy "玩家状态"
scoreboard objectives add jkbw.Player.Use.CD.AntiArrow dummy "玩家使用-剑气力场-冷却"
scoreboard objectives add jkbw.Player.Use.CD.BackScroll dummy "玩家使用-回城卷轴-冷却"
scoreboard objectives add jkbw.Player.Use.CD.Creature dummy "玩家使用-生物生成-冷却"
scoreboard objectives add jkbw.Player.Use.CD.Fireball dummy "玩家使用-火球-冷却"
scoreboard objectives add jkbw.Player.Use.CD.Gun dummy "玩家使用-枪械-冷却"
scoreboard objectives add jkbw.Player.Use.CD.Ice dummy "玩家使用-冰系道具-冷却"
scoreboard objectives add jkbw.Player.Use.CD.Platform dummy "玩家使用-急救平台-冷却"
scoreboard objectives add jkbw.Player.Use.CD.TheMirror dummy "玩家使用-魔镜-冷却"
scoreboard objectives add jkbw.Player.Use.Egg minecraft.used:egg "玩家使用-搭桥蛋"
scoreboard objectives add jkbw.Player.Use.Enderchest minecraft.used:endermite_spawn_egg "玩家放置-末影箱"
scoreboard objectives add jkbw.Player.Use.Last.AntiArrow dummy "玩家使用-剑气力场-持续"
scoreboard objectives add jkbw.Player.Use.Last.BackScroll dummy "玩家使用-回城卷轴-持续"
scoreboard objectives add jkbw.Player.Use.Last.Ice dummy "玩家使用-冰系道具-持续"
scoreboard objectives add jkbw.Player.Use.Last.TheMirror dummy "玩家使用-魔镜-持续"
scoreboard objectives add jkbw.Player.Use.Snowball minecraft.used:snowball "玩家使用-蠹虫"
scoreboard objectives add jkbw.Player.Use.TNT minecraft.used:mooshroom_spawn_egg "玩家使用-tnt"
scoreboard objectives add jkbw.Player.Use.Tower minecraft.used:husk_spawn_egg "玩家使用-快速建造塔"
scoreboard objectives add jkbw.Player.Use.Wall minecraft.used:fox_spawn_egg "玩家使用-安如磐石"
