...
{text: "QQ群", color: "red", underlined: true, hover_event: {action: "show_text", value: [{text: "610049362", color: "red"}]}, click_event: {action: "open_url", url: "https://qm.qq.com/q/KrUQJZKK08"}}, "\n\n", \
{text: "Modrinth", color: "green", underlined: true, hover_event: {action: "show_text", value: {text: "JesKi13567", color: "green"}}, click_event: {action: "open_url", url: "https://modrinth.com/user/JesKi13567"}}, "  ", \
