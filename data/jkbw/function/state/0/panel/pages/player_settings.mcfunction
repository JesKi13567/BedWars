...
execute if score #res_mode jkbw.mem matches 0 run data modify entity @n[type=text_display, tag=jkbw_txt] text set value [{storage: "jk:bw", nbt: "txt.ready.res_mode.0.name", color: "gold"}, {storage: "jk:bw", nbt: "txt.global.char.colon"}, {translate: "entity.minecraft.item", color: "gold"}]
execute if score #res_mode jkbw.mem matches 1 run data modify entity @n[type=text_display, tag=jkbw_txt] text set value [{storage: "jk:bw", nbt: "txt.ready.res_mode.1.name", color: "gold"}, {storage: "jk:bw", nbt: "txt.global.char.colon"}, {storage: "jk:bw", nbt: "txt.global.lvl", color: "gold"}]
execute if score #res_mode jkbw.mem matches 2 run data modify entity @n[type=text_display, tag=jkbw_txt] text set value [{storage: "jk:bw", nbt: "txt.ready.res_mode.1.name", color: "gold"}, {storage: "jk:bw", nbt: "txt.global.char.colon"}, {storage: "jk:bw", nbt: "txt.ready.res_mode.2.name", color: "gold"}]
...
execute if score #exp_mode jkbw.mem matches 0 run data modify entity @n[type=text_display, tag=jkbw_txt] text set value [{storage: "jk:bw", nbt: "txt.global.bool.disabled", color: "red"}]
execute if score #exp_mode jkbw.mem matches 1 run data modify entity @n[type=text_display, tag=jkbw_txt] text set value [{storage: "jk:bw", nbt: "txt.ready.exp_mode.1.name", color: "gold"}]
execute if score #exp_mode jkbw.mem matches 2 run data modify entity @n[type=text_display, tag=jkbw_txt] text set value [{storage: "jk:bw", nbt: "txt.ready.exp_mode.2.name", color: "gold"}]
execute if score #exp_mode jkbw.mem matches 3 run data modify entity @n[type=text_display, tag=jkbw_txt] text set value [{storage: "jk:bw", nbt: "txt.ready.exp_mode.3.name", color: "gold"}]
execute if score #exp_mode jkbw.mem matches 4 run data modify entity @n[type=text_display, tag=jkbw_txt] text set value [{storage: "jk:bw", nbt: "txt.ready.exp_mode.4.name", color: "gold"}]
execute if score #exp_mode jkbw.mem matches 5 run data modify entity @n[type=text_display, tag=jkbw_txt] text set value [{storage: "jk:bw", nbt: "txt.ready.exp_mode.5.name", color: "gold"}]
execute if score #exp_mode jkbw.mem matches 6 run data modify entity @n[type=text_display, tag=jkbw_txt] text set value [{storage: "jk:bw", nbt: "txt.ready.exp_mode.6.name", color: "gold"}]
...
execute if score #set_time jkbw.mem matches 0 run data modify entity @n[type=text_display, tag=jkbw_txt] text set value [{storage: "jk:bw", nbt: "txt.ready.set_time.1", color: "gold"}]
execute if score #set_time jkbw.mem matches 1 run data modify entity @n[type=text_display, tag=jkbw_txt] text set value [{storage: "jk:bw", nbt: "txt.ready.set_time.2", color: "gold"}]
execute if score #set_time jkbw.mem matches 2 run data modify entity @n[type=text_display, tag=jkbw_txt] text set value [{storage: "jk:bw", nbt: "txt.ready.set_time.3", color: "gold"}]
execute if score #set_time jkbw.mem matches 3 run data modify entity @n[type=text_display, tag=jkbw_txt] text set value [{storage: "jk:bw", nbt: "txt.ready.set_time.4", color: "gold"}]
