...
execute if score #attack_speed jkbw.int matches 1 run data modify entity @n[type=marker, tag=jkbw_player_settings, tag=attack_speed] CustomName set value {text: "1.9+", color: "gold"}
# 床种类
summon marker 10110222 1 10110222 {Tags: ["jkbw", "jkbw_player_settings", "bed_type"]}
execute if score #bed_type jkbw.int matches 0 run data modify entity @n[type=text_display, tag=jkbw_txt] text set value [{storage: "jk:bw", interpret: true, nbt: "txt.global.default", color: "gold"}]
execute if score #bed_type jkbw.int matches 1 run data modify entity @n[type=text_display, tag=jkbw_txt] text set value [{storage: "jk:bw", interpret: true, nbt: "txt.ready.bed_type.cover", color: "gold"}]
execute if score #bed_type jkbw.int matches 2 run data modify entity @n[type=text_display, tag=jkbw_txt] text set value [{translate: "block.minecraft.cake", color: "gold"}]
...
execute unless score #team_mode jkbw.int matches 1 run data modify entity @n[type=text_display, tag=jkbw_txt] text set value [{storage: "jk:bw", interpret: true, nbt: "txt.ready.team.distribute.0", color: "gold"}]
execute if score #team_mode jkbw.int matches 1 run data modify entity @n[type=text_display, tag=jkbw_txt] text set value [{storage: "jk:bw", interpret: true, nbt: "txt.ready.team.distribute.1", color: "gold"}]
...
data modify entity @n[type=text_display, tag=jkbw_txt] text set value [{color: "gold", score: {name: "#teams", objective: "jkbw.int"}}]
...
execute if score #res_mode jkbw.int matches 0 run data modify entity @n[type=text_display, tag=jkbw_txt] text set value [{storage: "jk:bw", interpret: true, nbt: "txt.ready.res_mode.0.name", color: "gold"}, {storage: "jk:bw", interpret: true, nbt: "txt.global.char.colon"}, {translate: "entity.minecraft.item", color: "gold"}]
execute if score #res_mode jkbw.int matches 1 run data modify entity @n[type=text_display, tag=jkbw_txt] text set value [{storage: "jk:bw", interpret: true, nbt: "txt.ready.res_mode.1.name", color: "gold"}, {storage: "jk:bw", interpret: true, nbt: "txt.global.char.colon"}, {storage: "jk:bw", interpret: true, nbt: "txt.global.lvl", color: "gold"}]
execute if score #res_mode jkbw.int matches 2 run data modify entity @n[type=text_display, tag=jkbw_txt] text set value [{storage: "jk:bw", interpret: true, nbt: "txt.ready.res_mode.1.name", color: "gold"}, {storage: "jk:bw", interpret: true, nbt: "txt.global.char.colon"}, {storage: "jk:bw", interpret: true, nbt: "txt.ready.res_mode.2.name", color: "gold"}]
...
execute if score #exp_mode jkbw.int matches 0 run data modify entity @n[type=text_display, tag=jkbw_txt] text set value [{storage: "jk:bw", interpret: true, nbt: "txt.global.bool.disabled", color: "red"}]
execute if score #exp_mode jkbw.int matches 1 run data modify entity @n[type=text_display, tag=jkbw_txt] text set value [{storage: "jk:bw", interpret: true, nbt: "txt.ready.exp_mode.1.name", color: "gold"}]
execute if score #exp_mode jkbw.int matches 2 run data modify entity @n[type=text_display, tag=jkbw_txt] text set value [{storage: "jk:bw", interpret: true, nbt: "txt.ready.exp_mode.2.name", color: "gold"}]
execute if score #exp_mode jkbw.int matches 3 run data modify entity @n[type=text_display, tag=jkbw_txt] text set value [{storage: "jk:bw", interpret: true, nbt: "txt.ready.exp_mode.3.name", color: "gold"}]
...
execute if score #exp_mode jkbw.int matches 8 run data modify entity @n[type=text_display, tag=jkbw_txt] text set value [{storage: "jk:bw", interpret: true, nbt: "txt.ready.exp_mode.8.name", color: "gold"}]
...
execute if score #set_time jkbw.int matches 0 run data modify entity @n[type=text_display, tag=jkbw_txt] text set value [{storage: "jk:bw", interpret: true, nbt: "txt.ready.set_time.1", color: "gold"}]
execute if score #set_time jkbw.int matches 1 run data modify entity @n[type=text_display, tag=jkbw_txt] text set value [{storage: "jk:bw", interpret: true, nbt: "txt.ready.set_time.2", color: "gold"}]
execute if score #set_time jkbw.int matches 2 run data modify entity @n[type=text_display, tag=jkbw_txt] text set value [{storage: "jk:bw", interpret: true, nbt: "txt.ready.set_time.3", color: "gold"}]
execute if score #set_time jkbw.int matches 3 run data modify entity @n[type=text_display, tag=jkbw_txt] text set value [{storage: "jk:bw", interpret: true, nbt: "txt.ready.set_time.4", color: "gold"}]
