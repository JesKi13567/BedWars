...
execute unless score #temp_check jkbw.int matches -1 if score #temp_score jkbw.int matches 1.. run function jkbw:state/0/panel/contents/map/rotation/set/check_loop
