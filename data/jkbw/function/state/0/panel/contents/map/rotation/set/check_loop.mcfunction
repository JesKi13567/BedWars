...
execute unless score #temp_check jkbw.mem matches -1 if score #temp_score jkbw.mem matches 1.. run function jkbw:state/0/panel/contents/map/rotation/set/check_loop
