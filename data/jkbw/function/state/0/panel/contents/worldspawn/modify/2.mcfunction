...
$function jkbw:state/0/panel/contents/worldspawn/border with storage jk:bw Map.maps.$(id)
...
# 记录点位
# 高度Y
$execute store result score #WY jkbw.mem run data get entity @n[type=text_display, tag=jkbw_worldspawn$(id)] Pos[1]
...
# 边界XZ
$execute store result score #WX jkbw.mem run data get entity @n[type=text_display, tag=jkbw_worldspawn$(id)] Pos[0]
$execute store result score #WZ jkbw.mem run data get entity @n[type=text_display, tag=jkbw_worldspawn$(id)] Pos[2]
