...
data modify entity @n[type=text_display, tag=jkbw_display_team_count] text set value [{storage: "jk:bw", interpret: true, nbt: "txt.ready.max", color: "yellow"}, {score: {name: "#teams_max", objective: "jkbw.mem"}}]
