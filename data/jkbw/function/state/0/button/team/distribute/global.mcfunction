...
# 人数过多，随机某玩家取消准备
execute if score #teams jkbw.mem matches 2 run function jkbw:state/0/button/team/distribute/sub/_2
execute if score #teams jkbw.mem matches 3 run function jkbw:state/0/button/team/distribute/sub/_3
execute if score #teams jkbw.mem matches 4 run function jkbw:state/0/button/team/distribute/sub/_4
execute if score #teams jkbw.mem matches 5 run function jkbw:state/0/button/team/distribute/sub/_5
execute if score #teams jkbw.mem matches 6 run function jkbw:state/0/button/team/distribute/sub/_6
execute if score #teams jkbw.mem matches 7 run function jkbw:state/0/button/team/distribute/sub/_7
execute if score #teams jkbw.mem matches 8 run function jkbw:state/0/button/team/distribute/sub/_8
