...
function jkbw:state/0/button/show/attack_speed
# 资源模式
...
function jkbw:state/0/button/show/res_mode
# 资源速率
...
function jkbw:state/0/button/show/res_rate
# 队伍数量
...
function jkbw:state/0/button/show/bed_type
# 实验模式
...
function jkbw:state/0/button/show/exp_mode
# 设置时间
