...
execute as @s[tag=res_global] as @p[gamemode=creative, distance=..6] if items entity @s weapon.mainhand *[custom_data={jkbw: ["eggs", "res_global"]}] if items entity @s weapon.offhand diamond_block run function jkbw:state/0/eggs/point/res/global {res: 'diamond', color: 'aqua'}
execute as @s[tag=res_global] as @p[gamemode=creative, distance=..6] if items entity @s weapon.mainhand *[custom_data={jkbw: ["eggs", "res_global"]}] if items entity @s weapon.offhand emerald_block run function jkbw:state/0/eggs/point/res/global {res: 'emerald', color: 'green'}
...
execute as @s[tag=delete] run function jkbw:state/0/eggs/point/delete/common
execute as @s[tag=delete_gp] run function jkbw:state/0/eggs/point/delete/global_point
kill @s
