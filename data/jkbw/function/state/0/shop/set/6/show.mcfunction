...
execute unless score #ACCESS_permanent_save jkbw.mem matches 1 run data modify entity @n[type=text_display, tag=jkbw_txt] text set value [{text: "[", color: "gray", italic: false}, {storage: "jk:bw", nbt: "txt.ready.rotating_items.permanent_save.name"}, "]"]
execute if score #ACCESS_permanent_save jkbw.mem matches 1 run data modify entity @n[type=text_display, tag=jkbw_txt] text set value [{text: "[", color: "green", italic: false}, {storage: "jk:bw", nbt: "txt.ready.rotating_items.permanent_save.name"}, "]"]
