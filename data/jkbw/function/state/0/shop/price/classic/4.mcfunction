...
{type: "object", atlas: "items", sprite: "item/chorus_fruit", hover_event: {action: "show_text", value: {translate: "item.minecraft.chorus_fruit"}}, click_event: {action: "suggest_command", command: "/scoreboard players set #fruit jkbw.int 2"}}, " ", \
...
tellraw @s ["", \
{selector: "@n[type=marker, tag=jkbw_rotating_items, tag=trident]", hover_event: {action: "show_text", value: {translate: "item.minecraft.trident"}}, click_event: {action: "run_command", command: "/trigger jkbw.Admin.Trigger set 251"}}, " ", \
{selector: "@n[type=marker, tag=jkbw_rotating_items, tag=tipped_arrow]", hover_event: {action: "show_text", value: {translate: "item.minecraft.tipped_arrow.effect.slowness"}}, click_event: {action: "run_command", command: "/trigger jkbw.Admin.Trigger set 252"}}, " ", \
{selector: "@n[type=marker, tag=jkbw_rotating_items, tag=crossbow_max]", hover_event: {action: "show_text", value: {storage: "jk:bw", interpret: true, nbt: "txt.shop.item.crossbow_max.name"}}, click_event: {action: "run_command", command: "/trigger jkbw.Admin.Trigger set 253"}}, " ", \
{selector: "@n[type=marker, tag=jkbw_rotating_items, tag=ice_bridge]", hover_event: {action: "show_text", value: {storage: "jk:bw", interpret: true, nbt: "txt.shop.item.ice_bridge.name"}}, click_event: {action: "run_command", command: "/trigger jkbw.Admin.Trigger set 254"}}, " ", \
{selector: "@n[type=marker, tag=jkbw_rotating_items, tag=mace]", hover_event: {action: "show_text", value: {translate: "item.minecraft.mace"}}, click_event: {action: "run_command", command: "/trigger jkbw.Admin.Trigger set 255"}}, " ", \
{selector: "@n[type=marker, tag=jkbw_rotating_items, tag=the_mirror]", hover_event: {action: "show_text", value: {storage: "jk:bw", interpret: true, nbt: "txt.shop.item.the_mirror.name"}}, click_event: {action: "run_command", command: "/trigger jkbw.Admin.Trigger set 256"}}, " ", \
