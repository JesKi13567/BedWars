...
summon text_display ~.5 ~ ~.5 {Tags: ["jkbw", "jkbw_chest_shop"], text: [{storage: "jk:bw", interpret: true, nbt: "txt.egg.shop", color: "aqua"}], billboard: "center", brightness: {block: 15, sky: 15}}
