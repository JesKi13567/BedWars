...
{Slot: 3b, id: "brick", count: 1, components: {custom_data: {jkbw: ["clean"]}, custom_name: {type: "object", atlas: "items", sprite: "item/brick", italic: false}, tooltip_display: {hidden_components: [can_break]}, can_break: {blocks: "#jkbw:candestroy"}, item_model: air}}, \
