setblock 10110222 5 10110222 shulker_box[facing=north]{lock: {components: {custom_name: {text: "JK"}}}, Items: [\
...
{Slot: 11b, id: "tnt", count: 1, components: {custom_data: {jkbw: ["shop", "gui", "3"]}}}, \
{Slot: 12b, id: "chorus_fruit", count: 1, components: {custom_data: {jkbw: ["shop", "gui", "4"]}}}, \
{Slot: 13b, id: "diamond_chestplate", count: 1, components: {custom_data: {jkbw: ["shop", "gui", "5"]}, attribute_modifiers: []}}, \
{Slot: 14b, id: "tripwire_hook", count: 1, components: {custom_data: {jkbw: ["shop", "gui", "6"]}}}, \
{Slot: 15b, id: "compass", count: 1, components: {custom_data: {jkbw: ["shop", "gui", "-8"]}}}, \
...
{Slot: 20b, id: "potion", count: 1, components: {custom_data: {jkbw: ["shop", "gui", "9"]}, potion_contents: "water", tooltip_display: {hidden_components: [potion_contents]}}}]}
