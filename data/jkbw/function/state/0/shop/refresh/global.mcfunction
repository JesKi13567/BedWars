...
{translate: "block.minecraft.lime_shulker_box", color: "green"}, {storage: "jk:bw", interpret: true, nbt: "txt.ready.control_panel.container_chunk.p4", color: "gold"}, {storage: "jk:bw", interpret: true, nbt: "txt.ready.solo_double"}, {storage: "jk:bw", interpret: true, nbt: "txt.ready.control_panel.container_chunk.p5", color: "gold"}, \
