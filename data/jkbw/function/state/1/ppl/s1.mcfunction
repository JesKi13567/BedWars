...
# 复活中
execute at @s[scores={jkbw.Player.State=3, jkbw.Player.RebornTime=1..}] run function jkbw:state/1/hurt/sub/death/title
...
execute as @s[gamemode=spectator] run function jkbw:state/1/ppl/s1/spectator/pos with storage jk:bw Map.cur
