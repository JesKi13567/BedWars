...
# 普通生成
$execute if score $$(team) jkbw.Team.res matches ..3 unless entity @e[type=item, tag=jkbw_extra_iron, distance=...1] run summon item ~ ~ ~ {Age: -32768, PickupDelay: 18, Invulnerable: True, Item: {id: "iron_ingot", count: 4}, Tags: ["jkbw_res", "jkbw_res_iron"]}
