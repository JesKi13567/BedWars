...
execute as @s[scores={jkbw.Player.Damage.Type.last=3}] run tellraw @a ["", {selector: "@s"}, {storage: "jk:bw", nbt: "txt.death.entity.p0"}, {selector: "@p[tag=jkbw_murder]"}, {storage: "jk:bw", nbt: "txt.death.entity.p1"}, {translate: "entity.minecraft.silverfish", color: "gold"}, {storage: "jk:bw", nbt: "txt.death.entity.p2"}]
execute as @s[scores={jkbw.Player.Damage.Type.last=4}] run tellraw @a ["", {selector: "@s"}, {storage: "jk:bw", nbt: "txt.death.entity.p0"}, {selector: "@p[tag=jkbw_murder]"}, {storage: "jk:bw", nbt: "txt.death.entity.p1"}, {translate: "entity.minecraft.iron_golem", color: "gold"}, {storage: "jk:bw", nbt: "txt.death.entity.p2"}]
...
execute if score #res_mode jkbw.mem matches 0..1 as @s[team=jkbw.blue] if score $blue jkbw.Bed.State matches 3 run tellraw @p[tag=jkbw_murder] {storage: "jk:bw", nbt: "txt.play.final_kill.p0", color: "green"}
execute if score #res_mode jkbw.mem matches 0..1 if score #teams jkbw.mem matches 3.. as @s[team=jkbw.green] if score $green jkbw.Bed.State matches 3 run tellraw @p[tag=jkbw_murder] {storage: "jk:bw", nbt: "txt.play.final_kill.p0", color: "green"}
execute if score #res_mode jkbw.mem matches 0..1 if score #teams jkbw.mem matches 4.. as @s[team=jkbw.yellow] if score $yellow jkbw.Bed.State matches 3 run tellraw @p[tag=jkbw_murder] {storage: "jk:bw", nbt: "txt.play.final_kill.p0", color: "green"}
execute if score #res_mode jkbw.mem matches 0..1 if score #teams jkbw.mem matches 5.. as @s[team=jkbw.cyan] if score $cyan jkbw.Bed.State matches 3 run tellraw @p[tag=jkbw_murder] {storage: "jk:bw", nbt: "txt.play.final_kill.p0", color: "green"}
execute if score #res_mode jkbw.mem matches 0..1 if score #teams jkbw.mem matches 6.. as @s[team=jkbw.white] if score $white jkbw.Bed.State matches 3 run tellraw @p[tag=jkbw_murder] {storage: "jk:bw", nbt: "txt.play.final_kill.p0", color: "green"}
execute if score #res_mode jkbw.mem matches 0..1 if score #teams jkbw.mem matches 7.. as @s[team=jkbw.pink] if score $pink jkbw.Bed.State matches 3 run tellraw @p[tag=jkbw_murder] {storage: "jk:bw", nbt: "txt.play.final_kill.p0", color: "green"}
execute if score #res_mode jkbw.mem matches 0..1 if score #teams jkbw.mem matches 8.. as @s[team=jkbw.gray] if score $gray jkbw.Bed.State matches 3 run tellraw @p[tag=jkbw_murder] {storage: "jk:bw", nbt: "txt.play.final_kill.p0", color: "green"}
