...
# 显示
bossbar set jkbw:game_progress name ["", {storage: "jk:bw", nbt: "txt.play.progress", color: "gold"}, {score: {name: "#time_show", objective: "jkbw.mem"}}, "s  ", {storage: "jk:bw", nbt: "txt.ready.exp_mode.4.loot_time", color: "yellow"}, {score: {name: "#shop_random_countdown", objective: "jkbw.mem"}}, "s"]
