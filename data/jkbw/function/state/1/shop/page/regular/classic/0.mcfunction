...
execute unless items entity @s enderchest.* *[custom_data={jkbw: ["shop", "gui", "1"]}] run scoreboard players set @s jkbw.Player.Page 1
execute unless items entity @s enderchest.* *[custom_data={jkbw: ["shop", "gui", "2"]}] run scoreboard players set @s jkbw.Player.Page 2
execute unless items entity @s enderchest.* *[custom_data={jkbw: ["shop", "gui", "3"]}] run scoreboard players set @s jkbw.Player.Page 3
execute unless items entity @s enderchest.* *[custom_data={jkbw: ["shop", "gui", "4"]}] run scoreboard players set @s jkbw.Player.Page 4
