...
$tellraw @s[tag=jkbw_buy_success] [{storage: "jk:bw", nbt: "txt.play.shop.buy.success", color: "green"}, " ", {translate: "item.minecraft.$(item)_pickaxe", color: "gold"}, {storage: "jk:bw", nbt: "txt.global.char.exclamation"}]
