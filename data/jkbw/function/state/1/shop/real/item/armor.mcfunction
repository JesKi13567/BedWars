...
# 失败购买（已拥有）
$tellraw @s[tag=jkbw_bought] [{storage: "jk:bw", nbt: "txt.play.shop.buy.ed.p0", color: "red"}, " ", {storage: "jk:bw", nbt: "txt.shop.item.armor.$(id)", color: "yellow"}, {storage: "jk:bw", nbt: "txt.global.char.comma"}, {storage: "jk:bw", nbt: "txt.play.shop.buy.ed.p1"}]
...
$tellraw @s[tag=!jkbw_bought, tag=jkbw_buy_success] [{storage: "jk:bw", nbt: "txt.play.shop.buy.success", color: "green"}, " ", {storage: "jk:bw", nbt: "txt.shop.item.armor.$(id)", color: "gold"}, {storage: "jk:bw", nbt: "txt.global.char.exclamation"}]
