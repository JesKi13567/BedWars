$execute as @s[scores={jkbw.Player.Levels.$(tool)=4}] run tellraw @s [{storage: "jk:bw", interpret: true, nbt: "txt.play.shop.buy.cannot", color: "red"}, " ", {storage: "jk:bw", interpret: true, nbt: "txt.shop.item.tool.$(tool)", color: "yellow"}, " ", {storage: "jk:bw", interpret: true, nbt: "txt.global.upgrade", color: "yellow"}, {storage: "jk:bw", interpret: true, nbt: "txt.global.char.comma"}, {storage: "jk:bw", interpret: true, nbt: "txt.play.becuz.lvl_max.self"}]
