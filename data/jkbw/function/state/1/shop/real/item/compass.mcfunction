...
$execute as @s[tag=jkbw_bought] run return run function jkbw:state/1/shop/bought {desc: '[{storage: "jk:bw", nbt: "txt.play.shop.buy.ed.p0", color: "red"}, {storage: "jk:bw", nbt: "txt.color.$(team)", color: "yellow"}, {storage: "jk:bw", nbt: "txt.global.team", color: "yellow"}, " ", {storage: "jk:bw", nbt: "txt.shop.item.compass.track", color: "yellow"}, {storage: "jk:bw", nbt: "txt.global.char.exclamation"}]'}
...
$execute if score #res_mode jkbw.mem matches 0 run tellraw @s[tag=!jkbw_buy_success] [{storage: "jk:bw", nbt: "txt.play.shop.buy.cannot", color: "red"}, " ", {storage: "jk:bw", nbt: "txt.color.$(team)", color: "yellow"}, {storage: "jk:bw", nbt: "txt.global.team", color: "yellow"}, " ", {storage: "jk:bw", nbt: "txt.shop.item.compass.track", color: "yellow"}, {storage: "jk:bw", nbt: "txt.global.char.comma"}, {storage: "jk:bw", nbt: "txt.play.shop.you_need"}, " ", {translate: "item.minecraft.emerald"}, "*", {score: {name: "#shop_temp", objective: "jkbw.mem"}, color: "yellow"}, {storage: "jk:bw", nbt: "txt.global.char.exclamation"}]
$execute if score #res_mode jkbw.mem matches 1 run tellraw @s[tag=!jkbw_buy_success] [{storage: "jk:bw", nbt: "txt.play.shop.buy.cannot", color: "red"}, " ", {storage: "jk:bw", nbt: "txt.color.$(team)", color: "yellow"}, {storage: "jk:bw", nbt: "txt.global.team", color: "yellow"}, " ", {storage: "jk:bw", nbt: "txt.shop.item.compass.track", color: "yellow"}, {storage: "jk:bw", nbt: "txt.global.char.comma"}, {storage: "jk:bw", nbt: "txt.play.shop.you_need"}, " ", {storage: "jk:bw", nbt: "txt.global.lvl"}, "*", {score: {name: "#shop_temp", objective: "jkbw.mem"}, color: "yellow"}, {storage: "jk:bw", nbt: "txt.global.char.exclamation"}]
playsound entity.villager.no player @s[tag=!jkbw_buy_success]

# 成功购买
$scoreboard players set @s[tag=jkbw_buy_success] jkbw.Player.Compass $(id)
$tellraw @s[tag=jkbw_buy_success] [{storage: "jk:bw", nbt: "txt.play.shop.buy.success", color: "green"}, " ", {storage: "jk:bw", nbt: "txt.color.$(team)", color: "gold"}, {storage: "jk:bw", nbt: "txt.global.team", color: "gold"}, " ", {storage: "jk:bw", nbt: "txt.shop.item.compass.track", color: "gold"}, {storage: "jk:bw", nbt: "txt.global.char.exclamation"}]
