...
# 其他提示
$execute if score #1 jkbw.mem matches $(id) as @s[tag=jkbw_buy_success] run tellraw @a[team=jkbw.$(team)] {storage: "jk:bw", nbt: "txt.shop.team.enchant.sword", color: "green"}
