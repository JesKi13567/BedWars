# 升级
$execute if score #TEAM_UPDATE.dragon jkbw.int matches 1.. unless items entity @s enderchest.* *[custom_data={jkbw: ["shop", "team", "dragon"]}] run function jkbw:state/1/shop/real/team/update/1 {team: '$(team)', item: 'dragon', id: 9}
...
$execute if score #exp_mode jkbw.int matches 7 if score #TEAM_UPDATE.deadshot jkbw.int matches 1.. unless items entity @s enderchest.* *[custom_data={jkbw: ["shop", "team", "deadshot"]}] run function jkbw:state/1/shop/real/team/update/1 {team: '$(team)', item: 'deadshot', id: 9}
