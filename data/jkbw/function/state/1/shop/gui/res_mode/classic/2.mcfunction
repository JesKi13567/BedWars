...
# 武器、盔甲与药水
execute unless score #BAN.classic.stone_sword jkbw.int matches 1 unless score #ENABLE.spear jkbw.int matches 2 run item replace entity @s enderchest.0 from block 10110221 6 10110222 container.0
execute unless score #BAN.classic.iron_sword jkbw.int matches 1 unless score #ENABLE.spear jkbw.int matches 2 run item replace entity @s enderchest.1 from block 10110221 6 10110222 container.1
execute unless score #BAN.classic.diamond_sword jkbw.int matches 1 unless score #ENABLE.spear jkbw.int matches 2 run item replace entity @s enderchest.2 from block 10110221 6 10110222 container.2
execute unless score #BAN.classic.stone_spear jkbw.int matches 1 if score #ENABLE.spear jkbw.int matches 1..2 run item replace entity @s enderchest.9 from block 10110221 6 10110222 container.9
execute unless score #BAN.classic.iron_spear jkbw.int matches 1 if score #ENABLE.spear jkbw.int matches 1..2 run item replace entity @s enderchest.10 from block 10110221 6 10110222 container.10
execute unless score #BAN.classic.diamond_spear jkbw.int matches 1 if score #ENABLE.spear jkbw.int matches 1..2 run item replace entity @s enderchest.11 from block 10110221 6 10110222 container.11
