...
execute if score $red jkbw.Bed.State matches 3 run item replace entity @s[team=!jkbw.red] enderchest.18 from block 10110215 5 10110222 container.9
execute if score $blue jkbw.Bed.State matches 3 run item replace entity @s[team=!jkbw.blue] enderchest.19 from block 10110215 5 10110222 container.10
execute if score #teams jkbw.mem matches 3.. if score $green jkbw.Bed.State matches 3 run item replace entity @s[team=!jkbw.green] enderchest.20 from block 10110215 5 10110222 container.11
execute if score #teams jkbw.mem matches 4.. if score $yellow jkbw.Bed.State matches 3 run item replace entity @s[team=!jkbw.yellow] enderchest.21 from block 10110215 5 10110222 container.12
execute if score #teams jkbw.mem matches 5.. if score $cyan jkbw.Bed.State matches 3 run item replace entity @s[team=!jkbw.cyan] enderchest.22 from block 10110215 5 10110222 container.13
execute if score #teams jkbw.mem matches 6.. if score $white jkbw.Bed.State matches 3 run item replace entity @s[team=!jkbw.white] enderchest.23 from block 10110215 5 10110222 container.14
execute if score #teams jkbw.mem matches 7.. if score $pink jkbw.Bed.State matches 3 run item replace entity @s[team=!jkbw.pink] enderchest.24 from block 10110215 5 10110222 container.15
execute if score #teams jkbw.mem matches 8.. if score $gray jkbw.Bed.State matches 3 run item replace entity @s[team=!jkbw.gray] enderchest.25 from block 10110215 5 10110222 container.16
