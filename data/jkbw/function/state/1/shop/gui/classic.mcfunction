...
execute unless score @s[scores={jkbw.Player.Page=8}] jkbw.Player.Page.Items = #shop_items_8 jkbw.mem run function jkbw:state/1/shop/gui/return
...
execute unless score @s[scores={jkbw.Player.Page=1}] jkbw.Player.Page.Items = #shop_items_1 jkbw.mem run function jkbw:state/1/shop/gui/classic/1
execute unless score @s[scores={jkbw.Player.Page=2}] jkbw.Player.Page.Items = #shop_items_2 jkbw.mem run function jkbw:state/1/shop/gui/classic/2
execute unless score @s[scores={jkbw.Player.Page=3}] jkbw.Player.Page.Items = #shop_items_3 jkbw.mem run function jkbw:state/1/shop/gui/classic/3
execute unless score @s[scores={jkbw.Player.Page=4}] jkbw.Player.Page.Items = #shop_items_4 jkbw.mem run function jkbw:state/1/shop/gui/classic/4
execute unless score @s[scores={jkbw.Player.Page=5}] jkbw.Player.Page.Items = #shop_items_5 jkbw.mem run function jkbw:state/1/shop/gui/classic/5
execute unless score @s[scores={jkbw.Player.Page=6}] jkbw.Player.Page.Items = #shop_items_6 jkbw.mem run function jkbw:state/1/shop/gui/classic/6
...
execute as @s[scores={jkbw.Player.Page=8}] run function jkbw:state/1/shop/gui/classic/8
