...
execute if score #res_mode jkbw.int matches 0..1 run return run function jkbw:state/1/shop/gui/page/shop

scoreboard players set @s jkbw.Player.Ray 10
execute if score #exp_mode jkbw.int matches 5 run scoreboard players set @s jkbw.Player.Ray 66
