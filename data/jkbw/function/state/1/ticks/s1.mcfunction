...
# 资源生成
execute unless score #exp_mode jkbw.int matches 4 run function jkbw:state/1/res/global

# 团队常驻
execute if score #res_mode jkbw.int matches 0..1 run function jkbw:state/1/shop/real/team/global
...
# 生命恢复
scoreboard players remove #heal jkbw.int 1
execute if score #heal jkbw.int matches ..0 run scoreboard players set #heal jkbw.int 5
