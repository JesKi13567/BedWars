...
execute if score #teams jkbw.int matches 3.. as @s[team=jkbw.green] run function jkbw:state/1/special/item/back_scroll/by_team {team: 'green'}
execute if score #teams jkbw.int matches 4.. as @s[team=jkbw.yellow] run function jkbw:state/1/special/item/back_scroll/by_team {team: 'yellow'}
execute if score #teams jkbw.int matches 5.. as @s[team=jkbw.cyan] run function jkbw:state/1/special/item/back_scroll/by_team {team: 'cyan'}
execute if score #teams jkbw.int matches 6.. as @s[team=jkbw.white] run function jkbw:state/1/special/item/back_scroll/by_team {team: 'white'}
execute if score #teams jkbw.int matches 7.. as @s[team=jkbw.pink] run function jkbw:state/1/special/item/back_scroll/by_team {team: 'pink'}
execute if score #teams jkbw.int matches 8.. as @s[team=jkbw.gray] run function jkbw:state/1/special/item/back_scroll/by_team {team: 'gray'}
