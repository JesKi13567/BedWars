...
$execute if items entity @s[scores={jkbw.Player.Use.CD.Platform=0}, nbt={OnGround: false}] weapon.$(hand)hand blaze_rod align xyz run function jkbw:state/1/special/item/platform/trigger
# 回城卷轴
...
$execute if items entity @s[scores={jkbw.Player.Use.CD.Ice=0}] weapon.$(hand)hand ice run function jkbw:state/1/special/item/ice/trigger
# 铁傀儡
