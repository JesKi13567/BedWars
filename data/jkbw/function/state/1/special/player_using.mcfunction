...
$execute if items entity @s[scores={jkbw.Player.Use.CD.Platform=0}, nbt={OnGround: false}] weapon.$(hand)hand blaze_rod align xyz run function jkbw:state/1/special/entity/platform/trigger
# 回城卷轴
...
$execute if items entity @s[scores={jkbw.Player.Use.CD.BackScroll=0}] weapon.$(hand)hand paper run function jkbw:state/1/special/item/back_scroll/trigger
# 剑气力场
...
$execute if items entity @s[scores={jkbw.Player.Use.CD.AntiArrow=0}] weapon.$(hand)hand prismarine_shard run function jkbw:state/1/special/item/anti_arrow/trigger
# 冰桥/真·冰霜行者
...
$execute if items entity @s[scores={jkbw.Player.Use.CD.Ice=0}] weapon.$(hand)hand ice run function jkbw:state/1/special/entity/ice/trigger
# 铁傀儡
