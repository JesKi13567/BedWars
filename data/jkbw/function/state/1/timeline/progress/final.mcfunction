...
execute if score #res_mode jkbw.mem matches 2 run tellraw @a ["", {translate: "entity.minecraft.wither", color: "aqua"}, {storage: "jk:bw", interpret: true, nbt: "txt.ready.res_mode.2.p2"}, {translate: "item.minecraft.bow", color: "aqua"}, {storage: "jk:bw", interpret: true, nbt: "txt.global.lock.uned"}, "\n(", {translate: "entity.minecraft.arrow", color: "yellow"}, {storage: "jk:bw", interpret: true, nbt: "txt.global.turn_into"}, {translate: "entity.minecraft.wither_skull", color: "yellow"}, ")"]
