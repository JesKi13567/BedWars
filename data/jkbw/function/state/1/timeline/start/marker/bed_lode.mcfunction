...
$scoreboard players set $$(team) jkbw.Team.deadshot 0
...
# 指针指向
$execute store result block 10110210 6 10110222 Items[$(id)].components.minecraft:lodestone_tracker.target.pos[0] int 1 run scoreboard players get @s jkbw.Entity.X
$execute store result block 10110210 6 10110222 Items[$(id)].components.minecraft:lodestone_tracker.target.pos[2] int 1 run scoreboard players get @s jkbw.Entity.Z
