...
title @a title {storage: "jk:bw", interpret: true, nbt: "txt.play.congrats", color: "yellow", bold: true}
...
tellraw @a [{storage: "jk:bw", interpret: true, nbt: "txt.play.win.players"}, {storage: "jk:bw", interpret: true, nbt: "txt.global.char.colon"}, {selector: "@a[tag=jkbw_win]"}]
