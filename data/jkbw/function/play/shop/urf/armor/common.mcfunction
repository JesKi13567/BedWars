...
$execute if score #5 jkbw.mem matches $(id) run give @s[tag=jkbw_buy_success] golden_leggings[can_break={predicates: [{blocks: "#jkbw:candestroy"}], show_in_tooltip: false}, enchantments={protection: 3}]
$execute if score #6 jkbw.mem matches $(id) run give @s[tag=jkbw_buy_success] golden_boots[can_break={predicates: [{blocks: "#jkbw:candestroy"}], show_in_tooltip: false}, enchantments={protection: 2}]
$execute if score #7 jkbw.mem matches $(id) run give @s[tag=jkbw_buy_success] diamond_helmet[can_break={predicates: [{blocks: "#jkbw:candestroy"}], show_in_tooltip: false}, enchantments={aqua_affinity: 1, respiration: 1, projectile_protection: 1}]
$execute if score #8 jkbw.mem matches $(id) run give @s[tag=jkbw_buy_success] diamond_chestplate[can_break={predicates: [{blocks: "#jkbw:candestroy"}], show_in_tooltip: false}, enchantments={blast_protection: 1, projectile_protection: 1, thorns: 1}]
$execute if score #9 jkbw.mem matches $(id) run give @s[tag=jkbw_buy_success] diamond_leggings[can_break={predicates: [{blocks: "#jkbw:candestroy"}], show_in_tooltip: false}, enchantments={fire_protection: 1, blast_protection: 1, thorns: 1}]
$execute if score #10 jkbw.mem matches $(id) run give @s[tag=jkbw_buy_success] diamond_boots[can_break={predicates: [{blocks: "#jkbw:candestroy"}], show_in_tooltip: false}, enchantments={feather_falling: 1, depth_strider: 1}]
