...
# 成功购买
$execute if score #1 jkbw.mem matches $(id) run function jkbw:_by_version/item/sword/wood
$execute if score #2 jkbw.mem matches $(id) run function jkbw:_by_version/item/sword/iron
$execute if score #3 jkbw.mem matches $(id) run function jkbw:_by_version/item/sword/diamond
$execute if score #4 jkbw.mem matches $(id) run function jkbw:_by_version/item/sword/gold
