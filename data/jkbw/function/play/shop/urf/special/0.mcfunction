...
# 成功购买
$execute if score #1 jkbw.mem matches $(id) run function jkbw:_by_version/item/tnt
...
$execute if score #2 jkbw.mem matches $(id) run function jkbw:_by_version/item/fireball
