...
execute unless score #test_mode jkbw.mem matches 1 if score #res_mode jkbw.mem matches 1..2 as @s[tag=jkbw_buy_success] run function jkbw:play/res/mode/xp_get
