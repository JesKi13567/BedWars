...
$execute unless items entity @s enderchest.* #jkbw:shop[custom_data={jkbw: ["shop", "team", "haste"]}] run function jkbw:play/shop/buy/5__2 {team: $(team), item: haste, aim: spawn}
$execute unless items entity @s enderchest.* #jkbw:shop[custom_data={jkbw: ["shop", "team", "res"]}] run function jkbw:play/shop/buy/5__4 {team: $(team), item: res, aim: res}
$execute unless items entity @s enderchest.* #jkbw:shop[custom_data={jkbw: ["shop", "team", "protection"]}] run function jkbw:play/shop/buy/5__4 {team: $(team), item: protect, aim: spawn}
