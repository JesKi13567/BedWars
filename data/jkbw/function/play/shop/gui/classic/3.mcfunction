...
execute if entity @e[type=text_display, tag=jkbw_bed_red, scores={jkbw.Bed.State=3}, limit=1] run item replace entity @s[team=!jkbw.red] enderchest.18 from block 10110215 5 10110222 container.0
execute if entity @e[type=text_display, tag=jkbw_bed_blue, scores={jkbw.Bed.State=3}, limit=1] run item replace entity @s[team=!jkbw.blue] enderchest.19 from block 10110215 5 10110222 container.1
execute if score #teams jkbw.mem matches 3.. if entity @e[type=text_display, tag=jkbw_bed_green, scores={jkbw.Bed.State=3}, limit=1] run item replace entity @s[team=!jkbw.green] enderchest.20 from block 10110215 5 10110222 container.2
execute if score #teams jkbw.mem matches 4.. if entity @e[type=text_display, tag=jkbw_bed_yellow, scores={jkbw.Bed.State=3}, limit=1] run item replace entity @s[team=!jkbw.yellow] enderchest.21 from block 10110215 5 10110222 container.3
execute if score #teams jkbw.mem matches 5.. if entity @e[type=text_display, tag=jkbw_bed_cyan, scores={jkbw.Bed.State=3}, limit=1] run item replace entity @s[team=!jkbw.cyan] enderchest.22 from block 10110215 5 10110222 container.4
execute if score #teams jkbw.mem matches 6.. if entity @e[type=text_display, tag=jkbw_bed_white, scores={jkbw.Bed.State=3}, limit=1] run item replace entity @s[team=!jkbw.white] enderchest.23 from block 10110215 5 10110222 container.5
execute if score #teams jkbw.mem matches 7.. if entity @e[type=text_display, tag=jkbw_bed_pink, scores={jkbw.Bed.State=3}, limit=1] run item replace entity @s[team=!jkbw.pink] enderchest.24 from block 10110215 5 10110222 container.6
execute if score #teams jkbw.mem matches 8.. if entity @e[type=text_display, tag=jkbw_bed_gray, scores={jkbw.Bed.State=3}, limit=1] run item replace entity @s[team=!jkbw.gray] enderchest.25 from block 10110215 5 10110222 container.7
