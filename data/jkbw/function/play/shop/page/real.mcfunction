# 商店商品缺失就算购买
execute as @s[scores={jkbw.Player.Page=1}] run function jkbw:play/shop/page/1
execute as @s[scores={jkbw.Player.Page=2}] run function jkbw:play/shop/page/2
execute as @s[scores={jkbw.Player.Page=3}] run function jkbw:play/shop/page/3
...
execute as @s[scores={jkbw.Player.Page=0}] run function jkbw:play/shop/page/0
