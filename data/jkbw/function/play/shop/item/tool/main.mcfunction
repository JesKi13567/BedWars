...
$execute as @s[scores={jkbw.Player.Levels.$(tool)=1}] run function jkbw:play/shop/item/tool/real {lvl: 2, tool: $(tool), res: iron_ingot}
$execute as @s[scores={jkbw.Player.Levels.$(tool)=0}] run function jkbw:play/shop/item/tool/real {lvl: 1, tool: $(tool), res: iron_ingot}
