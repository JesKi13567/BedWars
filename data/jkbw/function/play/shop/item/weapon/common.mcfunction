...
$execute if score #2 jkbw.mem matches $(id) run give @s[tag=jkbw_buy_success] shield[can_break={predicates: [{blocks: "#jkbw:candestroy"}], show_in_tooltip: false}, damage=326]
...
$execute if score #4 jkbw.mem matches $(id) run give @s[tag=jkbw_buy_success] trident[can_break={predicates: [{blocks: "#jkbw:candestroy"}], show_in_tooltip: false}, damage=248]
