...
# 成功购买
$execute if score #1 jkbw.mem matches $(id) run give @s[tag=jkbw_buy_success] potion[can_break={predicates: [{blocks: "#jkbw:candestroy"}], show_in_tooltip: false}, can_place_on={predicates: [{blocks: "#jkbw:canplaceon"}], show_in_tooltip: false}, potion_contents={custom_effects: [{id: "$(name)", amplifier: 1, duration: 900, show_particles: false}], custom_color: 3402751}, custom_name='{"translate": "item.minecraft.potion.effect.$(show)", "italic": false}', max_stack_size=64]
$execute if score #2 jkbw.mem matches $(id) run give @s[tag=jkbw_buy_success] potion[can_break={predicates: [{blocks: "#jkbw:candestroy"}], show_in_tooltip: false}, can_place_on={predicates: [{blocks: "#jkbw:canplaceon"}], show_in_tooltip: false}, potion_contents={custom_effects: [{id: "$(name)", amplifier: 4, duration: 900, show_particles: false}], custom_color: 16646020}, custom_name='{"translate": "item.minecraft.potion.effect.$(show)", "italic": false}', max_stack_size=64]
$execute if score #3 jkbw.mem matches $(id) run give @s[tag=jkbw_buy_success] potion[can_break={predicates: [{blocks: "#jkbw:candestroy"}], show_in_tooltip: false}, can_place_on={predicates: [{blocks: "#jkbw:canplaceon"}], show_in_tooltip: false}, potion_contents={custom_effects: [{id: "$(name)", amplifier: 0, duration: 600, show_particles: false}], custom_color: 16185078}, custom_name='{"translate": "item.minecraft.potion.effect.$(show)", "italic": false}', max_stack_size=64]
$execute if score #4 jkbw.mem matches $(id) run give @s[tag=jkbw_buy_success] potion[can_break={predicates: [{blocks: "#jkbw:candestroy"}], show_in_tooltip: false}, can_place_on={predicates: [{blocks: "#jkbw:canplaceon"}], show_in_tooltip: false}, potion_contents={custom_effects: [{id: "$(name)", amplifier: 0, duration: 600, show_particles: false}], custom_color: 5882118}, custom_name='{"translate": "item.minecraft.potion.effect.$(show)", "italic": false}', max_stack_size=64]
