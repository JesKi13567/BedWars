...
$execute if score #7 jkbw.mem matches $(id) run give @s[tag=jkbw_buy_success] blaze_rod[can_break={predicates: [{blocks: "#jkbw:candestroy"}], show_in_tooltip: false}, food={can_always_eat: true, eat_seconds: 100000, nutrition: 0, saturation: 0}]
