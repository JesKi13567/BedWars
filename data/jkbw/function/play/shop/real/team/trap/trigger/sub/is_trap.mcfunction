...
$title @a[team=jkbw.$(team)] subtitle [{storage: "jk:bw", nbt: "txt.play.triggered.this"}, " ", {storage: "jk:bw", nbt: "txt.shop.trap.list.1.name", color: "yellow"}, {storage: "jk:bw", nbt: "txt.global.char.exclamation"}]
