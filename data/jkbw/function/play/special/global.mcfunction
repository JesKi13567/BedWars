...
# 火球
execute as @e[type=marker, tag=jkbw_fireball_marker] at @s unless entity @e[type=fireball, tag=jkbw_fireball, distance=..2, limit=1] run function jkbw:play/special/fireball/explode
# 报警陷阱
...
# 风弹
execute as @e[type=wind_charge] run function jkbw:play/special/wind_charge
