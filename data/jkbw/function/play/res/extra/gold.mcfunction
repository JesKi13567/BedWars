...
execute as @s[scores={jkbw.ResCount.Gold=16..}] run summon item ~ ~ ~ {Age: -32768, PickupDelay: 18, Invulnerable: True, Item: {id: "gold_ingot", count: 16, components: {tooltip_display: {hidden_components: [can_break]}, can_break: {blocks: "#jkbw:candestroy"}}}, Tags: ["jkbw", "jkbw_extra_gold", "jkbw_res"], NoGravity: 1b}
...
execute as @s[tag=jkbw_gold_summon] unless entity @e[type=item, tag=jkbw_extra_gold, distance=...1] run summon item ~ ~ ~ {Age: -32768, PickupDelay: 18, Invulnerable: True, Item: {id: "gold_ingot", count: 1, components: {tooltip_display: {hidden_components: [can_break]}, can_break: {blocks: "#jkbw:candestroy"}}}, Tags: ["jkbw", "jkbw_res", "jkbw_res_gold"], NoGravity: 1b}
