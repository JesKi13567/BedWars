...
execute as @s[scores={jkbw.Team.Res=0..3, jkbw.ResCount.Iron=12..}] run summon item ~ ~ ~ {Age: -32768, PickupDelay: 18, Invulnerable: True, Item: {id: "iron_ingot", count: 48, components: {can_break: {predicates: [{blocks: "#jkbw:candestroy"}], show_in_tooltip: false}, can_place_on: {predicates: [{blocks: "#jkbw:canplaceon"}], show_in_tooltip: false}}}, Tags: ["jkbw", "jkbw_extra_iron", "jkbw_res"], NoGravity: 1b}
...
execute as @s[tag=jkbw_iron_summon, scores={jkbw.Team.Res=0..3}] unless entity @e[type=item, tag=jkbw_extra_iron, distance=...1] run summon item ~ ~ ~ {Age: -32768, PickupDelay: 18, Invulnerable: True, Item: {id: "iron_ingot", count: 4, components: {can_break: {predicates: [{blocks: "#jkbw:candestroy"}], show_in_tooltip: false}, can_place_on: {predicates: [{blocks: "#jkbw:canplaceon"}], show_in_tooltip: false}}}, Tags: ["jkbw", "jkbw_res", "jkbw_res_iron"], NoGravity: 1b}
execute as @s[tag=jkbw_iron_summon, scores={jkbw.Team.Res=4}] unless entity @e[type=item, tag=jkbw_extra_iron, distance=...1] run summon item ~ ~ ~ {Age: -32768, PickupDelay: 18, Invulnerable: True, Item: {id: "iron_ingot", count: 8, components: {can_break: {predicates: [{blocks: "#jkbw:candestroy"}], show_in_tooltip: false}, can_place_on: {predicates: [{blocks: "#jkbw:canplaceon"}], show_in_tooltip: false}}}, Tags: ["jkbw", "jkbw_res", "jkbw_res_iron"], NoGravity: 1b}
