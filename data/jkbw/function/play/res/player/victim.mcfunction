# 死亡提示
execute as @s[scores={jkbw.Player.Damage.Type.last=0}] run tellraw @a ["", {selector: "@s"}, " ", {storage: "jk:bw", nbt: "txt.death.victim.0.p0", color: "gray"}, " ", {selector: "@p[tag=jkbw_murder]"}, " ", {storage: "jk:bw", nbt: "txt.death.victim.0.p1", color: "gray"}]
execute as @s[scores={jkbw.Player.Damage.Type.last=1}] run tellraw @a ["", {selector: "@s"}, " ", {storage: "jk:bw", nbt: "txt.death.victim.1.p0", color: "gray"}, " ", {selector: "@p[tag=jkbw_murder]"}, " ", {storage: "jk:bw", nbt: "txt.death.victim.1.p1", color: "gray"}]
execute as @s[scores={jkbw.Player.Damage.Type.last=2}] run tellraw @a ["", {selector: "@s"}, " ", {storage: "jk:bw", nbt: "txt.death.victim.2.p0", color: "gray"}, " ", {selector: "@p[tag=jkbw_murder]"}, " ", {storage: "jk:bw", nbt: "txt.death.victim.2.p1", color: "gray"}]
execute as @s[scores={jkbw.Player.Damage.Type.last=3}] run tellraw @a ["", {selector: "@s"}, " ", {storage: "jk:bw", nbt: "txt.death.victim.3.p0", color: "gray"}, " ", {selector: "@p[tag=jkbw_murder]"}, " ", {storage: "jk:bw", nbt: "txt.death.victim.3.p1", color: "gray"}]
execute as @s[scores={jkbw.Player.Damage.Type.last=4}] run tellraw @a ["", {selector: "@s"}, " ", {storage: "jk:bw", nbt: "txt.death.victim.4.p0", color: "gray"}, " ", {selector: "@p[tag=jkbw_murder]"}, " ", {storage: "jk:bw", nbt: "txt.death.victim.4.p1", color: "gray"}]
execute as @s[scores={jkbw.Player.Damage.Type.last=5}] run tellraw @a ["", {selector: "@s"}, " ", {storage: "jk:bw", nbt: "txt.death.victim.5.p0", color: "gray"}, " ", {selector: "@p[tag=jkbw_murder]"}, " ", {storage: "jk:bw", nbt: "txt.death.victim.5.p1", color: "gray"}]
execute as @s[scores={jkbw.Player.Damage.Type.last=6}] run tellraw @a ["", {selector: "@s"}, " ", {storage: "jk:bw", nbt: "txt.death.victim.6.p0", color: "gray"}, " ", {selector: "@p[tag=jkbw_murder]"}, " ", {storage: "jk:bw", nbt: "txt.death.victim.6.p1", color: "gray"}]
execute as @s[scores={jkbw.Player.Damage.Type.last=7}] run tellraw @a ["", {selector: "@s"}, " ", {storage: "jk:bw", nbt: "txt.death.victim.7.p0", color: "gray"}, " ", {selector: "@p[tag=jkbw_murder]"}, " ", {storage: "jk:bw", nbt: "txt.death.victim.7.p1", color: "gray"}]
