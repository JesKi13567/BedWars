...
# 最终击杀
execute as @s[team=jkbw.red] if entity @e[type=text_display, tag=jkbw_bed_red, scores={jkbw.Bed.State=3}, limit=1] run tellraw @a {storage: "jk:bw", nbt: "txt.play.final_kill.name", color: "aqua", bold: true}
execute as @s[team=jkbw.blue] if entity @e[type=text_display, tag=jkbw_bed_blue, scores={jkbw.Bed.State=3}, limit=1] run tellraw @a {storage: "jk:bw", nbt: "txt.play.final_kill.name", color: "aqua", bold: true}
execute if score #teams jkbw.mem matches 3.. as @s[team=jkbw.green] if entity @e[type=text_display, tag=jkbw_bed_green, scores={jkbw.Bed.State=3}, limit=1] run tellraw @a {storage: "jk:bw", nbt: "txt.play.final_kill.name", color: "aqua", bold: true}
execute if score #teams jkbw.mem matches 4.. as @s[team=jkbw.yellow] if entity @e[type=text_display, tag=jkbw_bed_yellow, scores={jkbw.Bed.State=3}, limit=1] run tellraw @a {storage: "jk:bw", nbt: "txt.play.final_kill.name", color: "aqua", bold: true}
execute if score #teams jkbw.mem matches 5.. as @s[team=jkbw.cyan] if entity @e[type=text_display, tag=jkbw_bed_cyan, scores={jkbw.Bed.State=3}, limit=1] run tellraw @a {storage: "jk:bw", nbt: "txt.play.final_kill.name", color: "aqua", bold: true}
execute if score #teams jkbw.mem matches 6.. as @s[team=jkbw.white] if entity @e[type=text_display, tag=jkbw_bed_white, scores={jkbw.Bed.State=3}, limit=1] run tellraw @a {storage: "jk:bw", nbt: "txt.play.final_kill.name", color: "aqua", bold: true}
execute if score #teams jkbw.mem matches 7.. as @s[team=jkbw.pink] if entity @e[type=text_display, tag=jkbw_bed_pink, scores={jkbw.Bed.State=3}, limit=1] run tellraw @a {storage: "jk:bw", nbt: "txt.play.final_kill.name", color: "aqua", bold: true}
execute if score #teams jkbw.mem matches 8.. as @s[team=jkbw.gray] if entity @e[type=text_display, tag=jkbw_bed_gray, scores={jkbw.Bed.State=3}, limit=1] run tellraw @a {storage: "jk:bw", nbt: "txt.play.final_kill.name", color: "aqua", bold: true}
