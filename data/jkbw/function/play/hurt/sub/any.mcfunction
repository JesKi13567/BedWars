...
tellraw @s[tag=jkbw_invisible, scores={jkbw.Player.Damage.Type.now=2..}] [{storage: "jk:bw", nbt: "txt.play.becuz.attack.be", color: "yellow"}, {translate: "effect.minecraft.invisibility", color: "white"}, {storage: "jk:bw", nbt: "txt.play.no_effect_now"}]
