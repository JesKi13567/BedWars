tellraw @a ["\n", {"storage": "jk:bw", "nbt": "txt.print.rank.list", "bold": true}]
...
tellraw @a ["\n", {"storage": "jk:bw", "nbt": "txt.print.rank.1st", "color": "yellow", "bold": true}, " ", {"selector": "@a[tag=jkbw_rank1]"}, " - ", {"score": {"name": "#kill_max", "objective": "jkbw.mem"}, "bold": true}]
...
execute if entity @p[tag=jkbw_rank2] run tellraw @a ["\n", {"storage": "jk:bw", "nbt": "txt.print.rank.2nd", "color": "red", "bold": true}, " ", {"selector": "@a[tag=jkbw_rank2]"}, " - ", {"score": {"name": "#kill_max", "objective": "jkbw.mem"}, "bold": true}]
...
execute if entity @p[tag=jkbw_rank3] run tellraw @a ["\n", {"storage": "jk:bw", "nbt": "txt.print.rank.3rd", "color": "blue", "bold": true}, " ", {"selector": "@a[tag=jkbw_rank3]"}, " - ", {"score": {"name": "#kill_max", "objective": "jkbw.mem"}, "bold": true}]
