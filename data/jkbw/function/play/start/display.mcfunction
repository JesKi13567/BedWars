...
execute if score #exp_mode jkbw.mem matches 4 run tellraw @a ["", {storage: "jk:bw", nbt: "txt.display.exp_mode", color: "gold"}, ": ", {storage: "jk:bw", nbt: "txt.display.exp_mode5", color: "yellow"}, {storage: "jk:bw", nbt: "txt.print.turned_on", color: "gold"}]
