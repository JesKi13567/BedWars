...
tellraw @a ["\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n", {storage: "jk:bw", nbt: "txt.global.bedwars.left", color: "yellow"}, "\n", {translate: "attribute.name.attack_speed", color: "aqua"}, {storage: "jk:bw", nbt: "txt.global.char.colon"}, {selector: "@e[type=marker, tag=jkbw_display_attack, limit=1]"}]

execute if score #res_mode jkbw.mem matches 0 run tellraw @a ["", {storage: "jk:bw", nbt: "txt.ready.res_mode.name", color: "green"}, {storage: "jk:bw", nbt: "txt.global.char.colon"}, {storage: "jk:bw", nbt: "txt.ready.res_mode.0.name"}]
...
execute if score #exp_mode jkbw.mem matches 1 run tellraw @a ["", {storage: "jk:bw", nbt: "txt.ready.exp_mode.name", color: "yellow"}, {storage: "jk:bw", nbt: "txt.global.char.colon"}, {storage: "jk:bw", nbt: "txt.ready.exp_mode.1.name", color: "white"}, "\n", {storage: "jk:bw", nbt: "txt.ready.exp_mode.1.p3", color: "green"}]
execute if score #exp_mode jkbw.mem matches 2 run tellraw @a ["", {storage: "jk:bw", nbt: "txt.ready.exp_mode.name", color: "yellow"}, {storage: "jk:bw", nbt: "txt.global.char.colon"}, {storage: "jk:bw", nbt: "txt.ready.exp_mode.2.name", color: "white"}]
execute if score #exp_mode jkbw.mem matches 3 run tellraw @a ["", {storage: "jk:bw", nbt: "txt.ready.exp_mode.name", color: "yellow"}, {storage: "jk:bw", nbt: "txt.global.char.colon"}, {storage: "jk:bw", nbt: "txt.ready.exp_mode.3.name", color: "white"}]
execute if score #exp_mode jkbw.mem matches 4 run tellraw @a ["", {storage: "jk:bw", nbt: "txt.ready.exp_mode.name", color: "yellow"}, {storage: "jk:bw", nbt: "txt.global.char.colon"}, {storage: "jk:bw", nbt: "txt.ready.exp_mode.4.name", color: "white"}]
