...
execute if score #res_mode jkbw.mem matches 2 run tellraw @a ["", {translate: "entity.minecraft.wither", color: "aqua"}, {translate: "item.minecraft.bow", color: "aqua"}, {storage: "jk:bw", nbt: "txt.global.lock.uned"}, "\n(", {translate: "entity.minecraft.arrow", color: "yellow"}, {storage: "jk:bw", nbt: "txt.global.turn_into"}, {translate: "entity.minecraft.wither_skull", color: "yellow"}, ")."]
