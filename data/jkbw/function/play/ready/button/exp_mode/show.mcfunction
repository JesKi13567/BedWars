execute unless score #exp_mode jkbw.mem matches 1.. run data modify block 10110222 1 10110222 back_text.messages[0] set value '[{"storage": "jk:bw", "nbt": "txt.display.exp_mode1", "color": "gold"}]'
...
execute if score #exp_mode jkbw.mem matches 2 run data modify block 10110222 1 10110222 back_text.messages[0] set value '[{"storage": "jk:bw", "nbt": "txt.display.exp_mode3", "color": "red"}]'
...
execute unless score #exp_mode jkbw.mem matches 1.. as @e[type=item_display, tag=jkbw_show_exp_mode] run data modify entity @s item.id set value "redstone_torch"
...
execute unless score #exp_mode jkbw.mem matches 1.. run tellraw @a[distance=..20] [{"storage": "jk:bw", "nbt": "txt.print.bedwars", "color": "yellow"}," ",{"storage":"jk:bw", "nbt":"txt.display.exp_mode", "color": "gold"}, {"storage":"jk:bw", "nbt":"txt.print.turned_off", "color": "gold"}]
execute if score #exp_mode jkbw.mem matches 1 run tellraw @a[distance=..20] [{"storage": "jk:bw", "nbt": "txt.print.bedwars", "color": "yellow"}," ",{"storage":"jk:bw", "nbt":"txt.display.exp_mode2_1", "color": "green"}, {"translate": "block.minecraft.obsidian", "color": "green"}, {"storage":"jk:bw", "nbt":"txt.display.exp_mode2_2", "color": "green"}, {"translate": "item.minecraft.ender_pearl", "color": "green"}, {"storage":"jk:bw", "nbt":"txt.display.exp_mode2_3", "color": "green"}]
execute if score #exp_mode jkbw.mem matches 2 run tellraw @a[distance=..20] [{"storage": "jk:bw", "nbt": "txt.print.bedwars", "color": "yellow"}," ",{"storage":"jk:bw", "nbt":"txt.display.exp_mode3_", "color": "red"}]
