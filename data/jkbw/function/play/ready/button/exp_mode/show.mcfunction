...
execute if score #exp_mode jkbw.mem matches 0 run tellraw @a[distance=..20] [{storage: "jk:bw", nbt: "txt.print.bedwars", color: "yellow"}, {storage: "jk:bw", nbt: "txt.display.exp_mode", color: "light_purple"}, {storage: "jk:bw", nbt: "txt.print.turned_off", color: "red"}]
