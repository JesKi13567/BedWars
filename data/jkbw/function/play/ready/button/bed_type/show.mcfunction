...
execute if score #bed_type jkbw.mem matches 1 run data modify block 10110222 1 10110222 back_text.messages[0] set value [{"translate": "block.minecraft.cake", "color": "gold"}]
