...
execute as @e[type=text_display, tag=jkbw_display_team_count] run data modify entity @s text set value [{storage: "jk:bw", nbt: "txt.ready.max", color: "yellow"}, {score: {name: "#teams_max", objective: "jkbw.mem"}}]
