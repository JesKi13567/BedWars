...
execute if score #res_mode jkbw.mem matches 2 run data modify block 10110222 1 10110222 back_text.messages[0] set value '[{"storage": "jk:bw", "nbt": "txt.display.res_mode2", "color": "gold"}, ": ", {"storage": "jk:bw", "nbt": "txt.display.res_mode2_1", "color": "green"}]'
...
execute if score #res_mode jkbw.mem matches 0..1 run tellraw @a[distance=..20] [{"storage": "jk:bw", "nbt": "txt.print.bedwars", "color": "yellow"}," ",{"storage": "jk:bw", "nbt": "txt.display.how2play1", "color": "gold"}]
execute if score #res_mode jkbw.mem matches 2 run tellraw @a[distance=..20] [{"storage": "jk:bw", "nbt": "txt.print.bedwars", "color": "yellow"}," ",{"storage": "jk:bw", "nbt": "txt.display.how2play2", "color": "green"}]
