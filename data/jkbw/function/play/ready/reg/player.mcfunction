...
# 测试模式提示
execute if score #test_mode jkbw.mem matches 1 unless items entity @s hotbar.8 red_dye[custom_data={jkbw: ["reg", "0"]}] run item replace entity @s hotbar.8 from block 10110209 3 10110222 container.2
