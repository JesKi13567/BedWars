...
# 游戏描述
summon text_display ~.5 ~1.1 ~-3.5 {Tags: ["jkbw", "jkbw_show", "jkbw_ready_global"], text: [{storage: "jk:bw", nbt: "txt.ready.global", color: "aqua"}], brightness: {block: 15, sky: 15}, line_width: 1000}
...
summon interaction ~.5 ~2.25 ~5.5 {Tags: ["jkbw", "jkbw_show", "jkbw_button", "jkbw_button_attack_speed"], response: true, height: .5f, width: .5f}
function jkbw:play/ready/button/attack_speed/show
# 资源模式
summon text_display ~1.5 ~2.1 ~5.5 {Tags: ["jkbw", "jkbw_show"], text: [{storage: "jk:bw", nbt: "txt.ready.res_mode.name", color: "green"}], billboard: "center", brightness: {block: 15, sky: 15}}
...
summon interaction ~1.5 ~1.25 ~5.5 {Tags: ["jkbw", "jkbw_show", "jkbw_button", "jkbw_button_res_mode"], response: true, height: .5f, width: .5f}
function jkbw:play/ready/button/res_mode/show
# 资源速率
summon text_display ~2.5 ~2.1 ~4.5 {Tags: ["jkbw", "jkbw_show"], text: [{storage: "jk:bw", nbt: "txt.ready.res_speed.name", color: "green"}], billboard: "center", brightness: {block: 15, sky: 15}}
...
summon interaction ~2.5 ~1.25 ~4.5 {Tags: ["jkbw", "jkbw_show", "jkbw_button", "jkbw_button_res_rate"], response: true, height: .5f, width: .5f}
function jkbw:play/ready/button/res_rate/show
# 队伍数量
summon text_display ~-.5 ~2.4 ~5.5 {Tags: ["jkbw", "jkbw_show", "jkbw_display_team_count"], text: [{storage: "jk:bw", nbt: "txt.ready.max", color: "yellow"}, {score: {name: "#teams_max", objective: "jkbw.mem"}}], billboard: "center", brightness: {block: 15, sky: 15}}
summon text_display ~-.5 ~2.1 ~5.5 {Tags: ["jkbw", "jkbw_show"], text: [{storage: "jk:bw", nbt: "txt.ready.team.count", color: "light_purple"}], billboard: "center", brightness: {block: 15, sky: 15}}
...
summon interaction ~-.5 ~1.25 ~5.5 {Tags: ["jkbw", "jkbw_show", "jkbw_button", "jkbw_button_team_count"], response: true, height: .5f, width: .5f}
function jkbw:play/ready/button/team_count/show
# 队伍分配
summon text_display ~-1.5 ~2.1 ~4.5 {Tags: ["jkbw", "jkbw_show"], text: [{storage: "jk:bw", nbt: "txt.ready.team.distribute.name", color: "light_purple"}], billboard: "center", brightness: {block: 15, sky: 15}}
...
summon interaction ~-1.5 ~1.25 ~4.5 {Tags: ["jkbw", "jkbw_show", "jkbw_button", "jkbw_button_team_distribute"], response: true, height: .5f, width: .5f}
...
summon interaction ~.5 ~1.25 ~4.5 {Tags: ["jkbw", "jkbw_show", "jkbw_button", "jkbw_button_bed_type"], response: true, height: .5f, width: .5f}
function jkbw:play/ready/button/bed_type/show
# 实验模式
summon text_display ~2.5 ~3.1 ~5.5 {Tags: ["jkbw", "jkbw_show"], text: [{storage: "jk:bw", nbt: "txt.ready.exp_mode.name", color: "yellow"}], billboard: "center", brightness: {block: 15, sky: 15}}
...
summon interaction ~2.5 ~2.25 ~5.5 {Tags: ["jkbw", "jkbw_show", "jkbw_button", "jkbw_button_exp_mode"], response: true, height: .5f, width: .5f}
...
summon interaction ~-1.5 ~2.25 ~5.5 {Tags: ["jkbw", "jkbw_show", "jkbw_button", "jkbw_button_set_time"], response: true, height: .5f, width: .5f}
