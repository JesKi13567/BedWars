...
# 攻击速度
summon text_display ~.5 ~3.25 ~1.5 {billboard: "center", Tags: ["jkbw", "jkbw_show", "jkbw_new_display"], alignment: "center", line_width: 200, text: '""'}
...
# 资源模式
summon text_display ~1.5 ~2.25 ~1.5 {billboard: "center", Tags: ["jkbw", "jkbw_show", "jkbw_new_display"], alignment: "center", line_width: 200, text: '""'}
...
# 资源速率
summon text_display ~2.5 ~2.25 ~.5 {billboard: "center", Tags: ["jkbw", "jkbw_show", "jkbw_new_display"], alignment: "center", line_width: 200, text: '""'}
data modify block 10110222 1 10110222 back_text.messages[0] set value '[{"storage": "jk:bw", "nbt": "txt.display.res_speed", "color": "green"}]'
function jkbw:load/settings/menu/text_display
summon item_display ~2.5 ~1.5 ~.5 {billboard: "fixed", Tags: ["jkbw", "jkbw_show", "jkbw_show_res_rate"], item: {id: "feather", count: 1b}, transformation: {left_rotation: [0f, 0f, 0f, 1f], right_rotation: [0f, 0f, 0f, 1f], scale: [.5f, .5f, .5f], translation: [0f, 0f, 0f]}, CustomNameVisible: true, CustomName: '""'}
...
# 队伍数量
summon text_display ~-.5 ~2.7 ~1.5 {billboard: "center", Tags: ["jkbw", "jkbw_show", "jkbw_new_display", "jkbw_display_team_count"], alignment: "center", line_width: 200, text: '""'}
...
function jkbw:load/settings/menu/text_display
summon text_display ~-.5 ~2.25 ~1.5 {billboard: "center", Tags: ["jkbw", "jkbw_show", "jkbw_new_display"], alignment: "center", line_width: 200, text: '""'}
...
# 队伍分配
summon text_display ~-1.5 ~2.25 ~.5 {billboard: "center", Tags: ["jkbw", "jkbw_show", "jkbw_new_display"], alignment: "center", line_width: 200, text: '""'}
...
# 床模式
summon text_display ~.5 ~2.25 ~.5 {billboard: "center", Tags: ["jkbw", "jkbw_show", "jkbw_new_display"], alignment: "center", line_width: 200, text: '""'}
...
# 实验模式
summon text_display ~2.5 ~3.25 ~1.5 {billboard: "center", Tags: ["jkbw", "jkbw_show", "jkbw_new_display"], alignment: "center", line_width: 200, text: '""'}
data modify block 10110222 1 10110222 back_text.messages[0] set value '[{"storage": "jk:bw", "nbt": "txt.display.exp_mode", "color": "red"}]'
function jkbw:load/settings/menu/text_display
summon item_display ~2.5 ~2.5 ~1.5 {billboard: "fixed", Tags: ["jkbw", "jkbw_show", "jkbw_show_exp_mode"], item: {id: "redstone_torch", count: 1b}, transformation: {left_rotation: [0f, 0f, 0f, 1f], right_rotation: [0f, 0f, 0f, 1f], scale: [.5f, .5f, .5f], translation: [0f, 0f, 0f]}, CustomNameVisible: true, CustomName: '""'}
...
# 设置时间
summon text_display ~-1.5 ~3.25 ~1.5 {billboard: "center", Tags: ["jkbw", "jkbw_show", "jkbw_new_display"], alignment: "center", line_width: 200, text: '""'}
data modify block 10110222 1 10110222 back_text.messages[0] set value '[{"storage": "jk:bw", "nbt": "txt.display.set_time", "color": "yellow"}]'
function jkbw:load/settings/menu/text_display
summon item_display ~-1.5 ~2.5 ~1.5 {billboard: "fixed", Tags: ["jkbw", "jkbw_show", "jkbw_show_set_time"], item: {id: "clock", count: 1b}, transformation: {left_rotation: [0f, 0f, 0f, 1f], right_rotation: [0f, 0f, 0f, 1f], scale: [.5f, .5f, .5f], translation: [0f, 0f, 0f]}, CustomNameVisible: true, CustomName: '""'}
