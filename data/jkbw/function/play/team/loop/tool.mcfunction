...
## 给予
# 剪刀
execute unless items entity @s[scores={jkbw.Player.Levels.shears=1}] container.* shears[custom_data={jkbw: ["clean", "shears", "1"]}] unless items entity @s player.cursor shears unless items entity @s player.crafting.* shears unless items entity @s weapon.offhand shears run give @s shears[custom_data={jkbw: ["clean", "shears", "1"]}, tooltip_display={hidden_components: [can_break]}, can_break={blocks: "#jkbw:candestroy"}, unbreakable={}]
execute unless items entity @s[scores={jkbw.Player.Levels.shears=2}] container.* shears[custom_data={jkbw: ["clean", "shears", "2"]}] unless items entity @s player.cursor shears unless items entity @s player.crafting.* shears unless items entity @s weapon.offhand shears run give @s shears[custom_data={jkbw: ["clean", "shears", "2"]}, enchantments={efficiency: 1}, tooltip_display={hidden_components: [can_break]}, can_break={blocks: "#jkbw:candestroy"}, unbreakable={}]
execute unless items entity @s[scores={jkbw.Player.Levels.shears=3}] container.* shears[custom_data={jkbw: ["clean", "shears", "3"]}] unless items entity @s player.cursor shears unless items entity @s player.crafting.* shears unless items entity @s weapon.offhand shears run give @s shears[custom_data={jkbw: ["clean", "shears", "3"]}, enchantments={efficiency: 2}, tooltip_display={hidden_components: [can_break]}, can_break={blocks: "#jkbw:candestroy"}, unbreakable={}]
execute unless items entity @s[scores={jkbw.Player.Levels.shears=4}] container.* shears[custom_data={jkbw: ["clean", "shears", "4"]}] unless items entity @s player.cursor shears unless items entity @s player.crafting.* shears unless items entity @s weapon.offhand shears run give @s shears[custom_data={jkbw: ["clean", "shears", "4"]}, enchantments={efficiency: 4}, tooltip_display={hidden_components: [can_break]}, can_break={blocks: "#jkbw:candestroy"}, unbreakable={}]

# 镐子
execute unless items entity @s[scores={jkbw.Player.Levels.pickaxe=1}] container.* #jkbw:pickaxe/0[custom_data={jkbw: ["clean", "pickaxe", "1"]}] unless items entity @s player.cursor #jkbw:pickaxe/0 unless items entity @s player.crafting.* #jkbw:pickaxe/0 unless items entity @s weapon.offhand #jkbw:pickaxe/0 run give @s wooden_pickaxe[custom_data={jkbw: ["clean", "pickaxe", "1"]}, enchantments={efficiency: 1}, tooltip_display={hidden_components: [can_break]}, can_break={blocks: "#jkbw:candestroy"}, unbreakable={}]
execute unless items entity @s[scores={jkbw.Player.Levels.pickaxe=2}] container.* #jkbw:pickaxe/0[custom_data={jkbw: ["clean", "pickaxe", "2"]}] unless items entity @s player.cursor #jkbw:pickaxe/0 unless items entity @s player.crafting.* #jkbw:pickaxe/0 unless items entity @s weapon.offhand #jkbw:pickaxe/0 run give @s iron_pickaxe[custom_data={jkbw: ["clean", "pickaxe", "2"]}, enchantments={efficiency: 2}, tooltip_display={hidden_components: [can_break]}, can_break={blocks: "#jkbw:candestroy"}, unbreakable={}]
execute unless items entity @s[scores={jkbw.Player.Levels.pickaxe=3}] container.* #jkbw:pickaxe/0[custom_data={jkbw: ["clean", "pickaxe", "3"]}] unless items entity @s player.cursor #jkbw:pickaxe/0 unless items entity @s player.crafting.* #jkbw:pickaxe/0 unless items entity @s weapon.offhand #jkbw:pickaxe/0 run give @s golden_pickaxe[custom_data={jkbw: ["clean", "pickaxe", "3"]}, enchantments={efficiency: 3, sharpness: 2}, tooltip_display={hidden_components: [can_break]}, can_break={blocks: "#jkbw:candestroy"}, unbreakable={}]
execute unless items entity @s[scores={jkbw.Player.Levels.pickaxe=4}] container.* #jkbw:pickaxe/0[custom_data={jkbw: ["clean", "pickaxe", "4"]}] unless items entity @s player.cursor #jkbw:pickaxe/0 unless items entity @s player.crafting.* #jkbw:pickaxe/0 unless items entity @s weapon.offhand #jkbw:pickaxe/0 run give @s diamond_pickaxe[custom_data={jkbw: ["clean", "pickaxe", "4"]}, enchantments={efficiency: 3}, tooltip_display={hidden_components: [can_break]}, can_break={blocks: "#jkbw:candestroy"}, unbreakable={}]
