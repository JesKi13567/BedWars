...
execute unless items entity @s container.* #jkbw:sword/any unless items entity @s player.cursor #jkbw:sword/any unless items entity @s player.crafting.* #jkbw:sword/any unless items entity @s weapon.offhand #jkbw:sword/any run give @s wooden_sword[custom_data={jkbw: ["clean", "sword", "0"]}, unbreakable={}, can_break={predicates: [{blocks: "#jkbw:candestroy"}], show_in_tooltip: false}]
