...
$tellraw @s [{storage: "jk:bw", nbt: "txt.global.delete", color: "green"}, " ", {translate: "item.minecraft.filled_map", color: "yellow"}, " ", {text: "$(id)", color: "yellow"}, ", ", {translate: "gui.done", color: "green"}, "!"]
