...
{"selector": "@e[type=marker, limit=1, tag=jkbw_durability, tag=shield]", "hoverEvent": {"action": "show_text", "contents": ""}, "clickEvent": {"action": "run_command", "value": "/function jkbw:load/settings/menu/durability/set/shield"}}]

execute if score #res_mode jkbw.mem matches 0..1 run tellraw @a[tag=jkbw_admin] [\
{"selector": "@e[type=marker, limit=1, tag=jkbw_durability, tag=trident]", "hoverEvent": {"action": "show_text", "contents": ""}, "clickEvent": {"action": "run_command", "value": "/function jkbw:load/settings/menu/durability/set/trident"}}, " ", \
{"selector": "@e[type=marker, limit=1, tag=jkbw_durability, tag=mace]", "hoverEvent": {"action": "show_text", "contents": ""}, "clickEvent": {"action": "run_command", "value": "/function jkbw:load/settings/menu/durability/set/mace"}}]
