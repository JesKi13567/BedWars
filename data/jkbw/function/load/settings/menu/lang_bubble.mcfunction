summon marker 10110222 1 10110222 {Tags: ["jkbw", "jkbw_lang", "jkbw_lang1"], CustomName: {text: "[简体中文]", color: "white"}}
summon marker 10110222 1 10110222 {Tags: ["jkbw", "jkbw_lang", "jkbw_lang2"], CustomName: {text: "[English]", color: "white"}}
summon marker 10110222 1 10110222 {Tags: ["jkbw", "jkbw_lang", "jkbw_lang3"], CustomName: {text: "[繁體中文]", color: "white"}}
