...
$execute if score #team_point jkbw.mem matches 1 run data modify entity @e[type=marker, tag=jkbw_check_spawn_$(team), limit=1] CustomName set value {text: "■", color: "$(color)"}
...
$execute if score #team_point jkbw.mem matches 2.. run data modify entity @e[type=marker, tag=jkbw_check_res_$(team), limit=1] CustomName set value {text: "=", color: "$(color)"}
$execute if score #team_point jkbw.mem matches 1 run data modify entity @e[type=marker, tag=jkbw_check_res_$(team), limit=1] CustomName set value {text: "■", color: "$(color)"}
$execute if score #team_point jkbw.mem matches 0 run data modify entity @e[type=marker, tag=jkbw_check_res_$(team), limit=1] CustomName set value {text: "□", color: "$(color)"}
