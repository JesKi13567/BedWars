...
$execute align xyz run summon text_display ~.5 ~.5 ~.5 {Tags: ["jkbw", "jkbw_bed_$(team)", "jkbw_bed_display"], text: [{"storage": "jk:bw", "nbt": "txt.display.team.$(team)", "color": "$(color)"}, {"storage": "jk:bw", "nbt": "txt.display.bed_point"}], billboard: "center", alignment: "center", line_width: 200}
