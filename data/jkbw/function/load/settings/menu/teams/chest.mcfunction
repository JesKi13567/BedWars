...
$data modify entity @e[type=text_display, tag=jkbw_txt, limit=1] text set value [{storage: "jk:bw", nbt: "txt.color.$(team)", color: "$(color)"}, {storage: "jk:bw", nbt: "txt.global.team"}, {storage: "jk:bw", nbt: "txt.global._s"}, {translate: "block.minecraft.barrel"}]
