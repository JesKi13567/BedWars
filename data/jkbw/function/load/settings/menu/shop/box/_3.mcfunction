...
{Slot: 4b, id: "ice", count: 1b, components: {custom_data: {jkbw: ["shop", "urf", "ice"]}, lore: ["", ""]}}, \
{Slot: 5b, id: "paper", count: 1b, components: {custom_data: {jkbw: ["shop", "urf", "back"]}, lore: ["", ""]}}, \
{Slot: 6b, id: "compass", count: 1b, components: {custom_data: {jkbw: ["shop", "urf", "compass"]}, lore: ["", ""]}}, \
{Slot: 7b, id: "ender_pearl", count: 1b, components: {custom_data: {jkbw: ["shop", "urf", "pearl"]}, lore: [""]}}, \
{Slot: 8b, id: "prismarine_shard", count: 1b, components: {custom_data: {jkbw: ["shop", "urf", "anti_arrow"]}, lore: ["", ""]}}, \
{Slot: 9b, id: "fire_charge", count: 1b, components: {custom_data: {jkbw: ["shop", "urf", "fire_charge"]}, lore: ["", ""]}}, \
...
{Slot: 13b, id: "happy_ghast_spawn_egg", count: 1b, components: {custom_data: {jkbw: ["shop", "urf", "happy_ghast"]}, lore: [""]}}, \
