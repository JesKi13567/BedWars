...
#urfXPstone_spear
data modify block ~ ~ ~ back_text.messages[1] set value [{storage: "jk:bw", nbt: "txt.item.shop.cost", "italic": false, color: "gray"}, {score: {name: "#urfXPstone_spear", objective: "jkbw.mem"}, color: "aqua"}, " ", {storage: "jk:bw", nbt: "txt.item.shop.lvl", "italic": false, color: "aqua"}]
data modify block 10110219 4 10110222 Items[6].components.minecraft:lore[0] set from block ~ ~ ~ back_text.messages[1]
#urfXPcopper_spear
data modify block ~ ~ ~ back_text.messages[1] set value [{storage: "jk:bw", nbt: "txt.item.shop.cost", "italic": false, color: "gray"}, {score: {name: "#urfXPcopper_spear", objective: "jkbw.mem"}, color: "aqua"}, " ", {storage: "jk:bw", nbt: "txt.item.shop.lvl", "italic": false, color: "aqua"}]
data modify block 10110219 4 10110222 Items[7].components.minecraft:lore[0] set from block ~ ~ ~ back_text.messages[1]
#urfXPiron_spear
data modify block ~ ~ ~ back_text.messages[1] set value [{storage: "jk:bw", nbt: "txt.item.shop.cost", "italic": false, color: "gray"}, {score: {name: "#urfXPiron_spear", objective: "jkbw.mem"}, color: "aqua"}, " ", {storage: "jk:bw", nbt: "txt.item.shop.lvl", "italic": false, color: "aqua"}]
data modify block 10110219 4 10110222 Items[8].components.minecraft:lore[0] set from block ~ ~ ~ back_text.messages[1]
#urfXPdiamond_spear
data modify block ~ ~ ~ back_text.messages[1] set value [{storage: "jk:bw", nbt: "txt.item.shop.cost", "italic": false, color: "gray"}, {score: {name: "#urfXPdiamond_spear", objective: "jkbw.mem"}, color: "aqua"}, " ", {storage: "jk:bw", nbt: "txt.item.shop.lvl", "italic": false, color: "aqua"}]
data modify block 10110219 4 10110222 Items[9].components.minecraft:lore[0] set from block ~ ~ ~ back_text.messages[1]
#urfXPnetherite_spear
data modify block ~ ~ ~ back_text.messages[1] set value [{storage: "jk:bw", nbt: "txt.item.shop.cost", "italic": false, color: "gray"}, {score: {name: "#urfXPnetherite_spear", objective: "jkbw.mem"}, color: "aqua"}, " ", {storage: "jk:bw", nbt: "txt.item.shop.lvl", "italic": false, color: "aqua"}]
data modify block 10110219 4 10110222 Items[10].components.minecraft:lore[0] set from block ~ ~ ~ back_text.messages[1]
